...
|[List CalendarGroup](../api/user_post_calendargroups.md) |[CalendarGroup](calendargroup.md)| Get a CalendarGroup object collection.|
...
|[List Event](../api/calendargroups_post_calendarview.md) |[Event](event.md)| Get a Event object collection.|
...
|[List Calendar](../api/calendarview_post_calendars.md) |[Calendar](calendar.md)| Get a Calendar object collection.|
...
|[List ContactFolder](../api/calendars_post_contactfolders.md) |[ContactFolder](contactfolder.md)| Get a ContactFolder object collection.|
...
|[List Contact](../api/contactfolders_post_contacts.md) |[Contact](contact.md)| Get a Contact object collection.|
|[Create Event](../api/contacts_post_events.md) |[Event](event.md)| Create a new Event by posting to the Events collection.|
|[List Event](../api/contacts_post_events.md) |[Event](event.md)| Get a Event object collection.|
|[Create Group](../api/events_post_joinedgroups.md) |[Group](group.md)| Create a new Group by posting to the JoinedGroups collection.|
|[List Group](../api/events_post_joinedgroups.md) |[Group](group.md)| Get a Group object collection.|
...
|[List MailFolder](../api/joinedgroups_post_mailfolders.md) |[MailFolder](mailfolder.md)| Get a MailFolder object collection.|
...
|[List Message](../api/mailfolders_post_messages.md) |[Message](message.md)| Get a Message object collection.|
...
|[List File](../api/messages_post_trendingaround.md) |[File](file.md)| Get a File object collection.|
...
|[List User](../api/trendingaround_post_workingwith.md) |[User](user.md)| Get a User object collection.|
...
|[List AppRoleAssignment](../api/workingwith_post_approleassignments.md) |[AppRoleAssignment](approleassignment.md)| Get a AppRoleAssignment object collection.|
...
|[List directReport](../api/createdobjects_post_directreports.md) |[DirectoryObject](directoryobject.md)| Get a directReport object collection.|
...
|[List ownedDevice](../api/oauth2permissiongrants_post_owneddevices.md) |[DirectoryObject](directoryobject.md)| Get a ownedDevice object collection.|
...
|[List ownedObject](../api/owneddevices_post_ownedobjects.md) |[DirectoryObject](directoryobject.md)| Get a ownedObject object collection.|
|[Create Plan](../api/ownedobjects_post_plans.md) |[Plan](plan.md)| Create a new Plan by posting to the plans collection.|
|[List Plan](../api/ownedobjects_post_plans.md) |[Plan](plan.md)| Get a Plan object collection.|
...
|[List registeredDevice](../api/plans_post_registereddevices.md) |[DirectoryObject](directoryobject.md)| Get a registeredDevice object collection.|
|[Create Task](../api/registereddevices_post_tasks.md) |[Task](task.md)| Create a new Task by posting to the tasks collection.|
|[List Task](../api/registereddevices_post_tasks.md) |[Task](task.md)| Get a Task object collection.|
