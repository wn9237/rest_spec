...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/skew_pFunctionReturnSet
POST /me/drive/root/workbook/functions/skew_pFunctionReturnSet
POST /workbooks/<id>/workbook/functions/skew_pFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/skew_pFunctionReturnSet
