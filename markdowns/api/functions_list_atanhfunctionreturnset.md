...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/atanhFunctionReturnSet
GET /me/drive/root/workbook/functions/atanhFunctionReturnSet
GET /workbooks/<id>/workbook/functions/atanhFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_atanhfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/atanhFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List atanhFunctionReturnSet",
  "keywords": "",
