...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rank_AvgFunctionReturnSet
POST /me/drive/root/workbook/functions/rank_AvgFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rank_AvgFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rank_AvgFunctionReturnSet
