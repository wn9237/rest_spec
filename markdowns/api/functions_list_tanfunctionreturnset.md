...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/tanFunctionReturnSet
GET /me/drive/root/workbook/functions/tanFunctionReturnSet
GET /workbooks/<id>/workbook/functions/tanFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_tanfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tanFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List tanFunctionReturnSet",
  "keywords": "",
