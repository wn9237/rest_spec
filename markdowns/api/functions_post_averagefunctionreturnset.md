...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/averageFunctionReturnSet
POST /me/drive/root/workbook/functions/averageFunctionReturnSet
POST /workbooks/<id>/workbook/functions/averageFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/averageFunctionReturnSet
