...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/acothFunctionReturnSet
GET /me/drive/root/workbook/functions/acothFunctionReturnSet
GET /workbooks/<id>/workbook/functions/acothFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_acothfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acothFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List acothFunctionReturnSet",
  "keywords": "",
