...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/coupNumFunctionReturnSet
POST /me/drive/root/workbook/functions/coupNumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/coupNumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coupNumFunctionReturnSet
