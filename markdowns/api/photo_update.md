...
<!-- { "blockType": "ignored" } -->
```http
PATCH https://graph.microsoft.com/v1.0/users/<objectId>/UserPhoto
PATCH https://graph.microsoft.com/v1.0/groups/<objectId>/GroupPhoto
PATCH https://graph.microsoft.com/v1.0/drive/root/createdByUser/UserPhoto
```
