...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sqrtFunctionReturnSet
POST /me/drive/root/workbook/functions/sqrtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sqrtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sqrtFunctionReturnSet
