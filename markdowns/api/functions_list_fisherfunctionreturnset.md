...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/fisherFunctionReturnSet
GET /me/drive/root/workbook/functions/fisherFunctionReturnSet
GET /workbooks/<id>/workbook/functions/fisherFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_fisherfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fisherFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List fisherFunctionReturnSet",
  "keywords": "",
