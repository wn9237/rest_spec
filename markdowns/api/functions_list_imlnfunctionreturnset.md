...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imLnFunctionReturnSet
GET /me/drive/root/workbook/functions/imLnFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imLnFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imlnfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imLnFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imLnFunctionReturnSet",
  "keywords": "",
