...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/valueFunctionReturnSet
POST /me/drive/root/workbook/functions/valueFunctionReturnSet
POST /workbooks/<id>/workbook/functions/valueFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/valueFunctionReturnSet
