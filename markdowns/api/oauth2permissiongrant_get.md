...
GET https://graph.microsoft.com/v1.0/users/<objectId>/oauth2PermissionGrants/<objectId>
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/oauth2PermissionGrants/<objectId>
```
