...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/largeFunctionReturnSet
POST /me/drive/root/workbook/functions/largeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/largeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/largeFunctionReturnSet
