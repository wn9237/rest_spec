...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imCschFunctionReturnSet
GET /me/drive/root/workbook/functions/imCschFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imCschFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imcschfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCschFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imCschFunctionReturnSet",
  "keywords": "",
