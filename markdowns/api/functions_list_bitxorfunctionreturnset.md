...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/bitxorFunctionReturnSet
GET /me/drive/root/workbook/functions/bitxorFunctionReturnSet
GET /workbooks/<id>/workbook/functions/bitxorFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_bitxorfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitxorFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List bitxorFunctionReturnSet",
  "keywords": "",
