...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dcountAFunctionReturnSet
POST /me/drive/root/workbook/functions/dcountAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dcountAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dcountAFunctionReturnSet
