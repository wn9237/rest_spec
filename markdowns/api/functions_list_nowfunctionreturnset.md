...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/nowFunctionReturnSet
GET /me/drive/root/workbook/functions/nowFunctionReturnSet
GET /workbooks/<id>/workbook/functions/nowFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_nowfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nowFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List nowFunctionReturnSet",
  "keywords": "",
