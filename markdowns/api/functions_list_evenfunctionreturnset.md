...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/evenFunctionReturnSet
GET /me/drive/root/workbook/functions/evenFunctionReturnSet
GET /workbooks/<id>/workbook/functions/evenFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_evenfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/evenFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List evenFunctionReturnSet",
  "keywords": "",
