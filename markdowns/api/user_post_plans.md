...
<!-- { "blockType": "ignored" } -->
```http
POST https://graph.microsoft.com/v1.0/users/<objectId>/plans
POST https://graph.microsoft.com/v1.0/drive/root/createdByUser/plans
POST https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/plans
