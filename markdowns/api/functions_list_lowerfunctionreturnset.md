...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/lowerFunctionReturnSet
GET /me/drive/root/workbook/functions/lowerFunctionReturnSet
GET /workbooks/<id>/workbook/functions/lowerFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_lowerfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lowerFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List lowerFunctionReturnSet",
  "keywords": "",
