...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSinhFunctionReturnSet
GET /me/drive/root/workbook/functions/imSinhFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSinhFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsinhfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSinhFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSinhFunctionReturnSet",
  "keywords": "",
