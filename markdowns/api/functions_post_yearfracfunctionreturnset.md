...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/yearFracFunctionReturnSet
POST /me/drive/root/workbook/functions/yearFracFunctionReturnSet
POST /workbooks/<id>/workbook/functions/yearFracFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yearFracFunctionReturnSet
