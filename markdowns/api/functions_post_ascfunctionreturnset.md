...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ascFunctionReturnSet
POST /me/drive/root/workbook/functions/ascFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ascFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ascFunctionReturnSet
