...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/accrIntFunctionReturnSet
POST /me/drive/root/workbook/functions/accrIntFunctionReturnSet
POST /workbooks/<id>/workbook/functions/accrIntFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/accrIntFunctionReturnSet
