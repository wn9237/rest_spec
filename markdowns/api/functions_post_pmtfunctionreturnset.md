...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/pmtFunctionReturnSet
POST /me/drive/root/workbook/functions/pmtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/pmtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/pmtFunctionReturnSet
