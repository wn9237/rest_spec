...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/devSqFunctionReturnSet
GET /me/drive/root/workbook/functions/devSqFunctionReturnSet
GET /workbooks/<id>/workbook/functions/devSqFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_devsqfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/devSqFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List devSqFunctionReturnSet",
  "keywords": "",
