...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSinhFunctionReturnSet
POST /me/drive/root/workbook/functions/imSinhFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSinhFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSinhFunctionReturnSet
