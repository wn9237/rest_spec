...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/properFunctionReturnSet
GET /me/drive/root/workbook/functions/properFunctionReturnSet
GET /workbooks/<id>/workbook/functions/properFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_properfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/properFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List properFunctionReturnSet",
  "keywords": "",
