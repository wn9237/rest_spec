...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dollarFunctionReturnSet
GET /me/drive/root/workbook/functions/dollarFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dollarFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dollarfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dollarFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dollarFunctionReturnSet",
  "keywords": "",
