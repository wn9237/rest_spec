...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/coupDayBsFunctionReturnSet
POST /me/drive/root/workbook/functions/coupDayBsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/coupDayBsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coupDayBsFunctionReturnSet
