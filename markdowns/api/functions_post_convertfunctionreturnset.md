...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/convertFunctionReturnSet
POST /me/drive/root/workbook/functions/convertFunctionReturnSet
POST /workbooks/<id>/workbook/functions/convertFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/convertFunctionReturnSet
