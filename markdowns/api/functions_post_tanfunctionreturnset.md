...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/tanFunctionReturnSet
POST /me/drive/root/workbook/functions/tanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/tanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tanFunctionReturnSet
