...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imTanFunctionReturnSet
GET /me/drive/root/workbook/functions/imTanFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imTanFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imtanfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imTanFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imTanFunctionReturnSet",
  "keywords": "",
