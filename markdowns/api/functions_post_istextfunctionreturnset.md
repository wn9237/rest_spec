...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isTextFunctionReturnSet
POST /me/drive/root/workbook/functions/isTextFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isTextFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isTextFunctionReturnSet
