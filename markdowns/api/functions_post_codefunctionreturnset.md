...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/codeFunctionReturnSet
POST /me/drive/root/workbook/functions/codeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/codeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/codeFunctionReturnSet
