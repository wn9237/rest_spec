...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cleanFunctionReturnSet
POST /me/drive/root/workbook/functions/cleanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cleanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cleanFunctionReturnSet
