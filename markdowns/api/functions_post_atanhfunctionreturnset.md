...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/atanhFunctionReturnSet
POST /me/drive/root/workbook/functions/atanhFunctionReturnSet
POST /workbooks/<id>/workbook/functions/atanhFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/atanhFunctionReturnSet
