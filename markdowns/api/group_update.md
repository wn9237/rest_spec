...
PATCH https://graph.microsoft.com/v1.0/users/<objectId>/JoinedGroups/<objectId>
PATCH https://graph.microsoft.com/v1.0/drive/root/createdByUser/JoinedGroups/<objectId>
```
