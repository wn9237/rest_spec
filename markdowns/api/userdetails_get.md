...
<!-- { "blockType": "ignored" } -->
```http
GET https://graph.microsoft.com/v1.0/users/<objectId>/details
GET https://graph.microsoft.com/v1.0/groups/<objectId>/details
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/details
```
