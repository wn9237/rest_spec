...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/oct2BinFunctionReturnSet
POST /me/drive/root/workbook/functions/oct2BinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/oct2BinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oct2BinFunctionReturnSet
