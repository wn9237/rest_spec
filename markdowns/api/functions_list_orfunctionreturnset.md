...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/orFunctionReturnSet
GET /me/drive/root/workbook/functions/orFunctionReturnSet
GET /workbooks/<id>/workbook/functions/orFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_orfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/orFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List orFunctionReturnSet",
  "keywords": "",
