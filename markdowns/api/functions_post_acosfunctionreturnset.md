...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/acosFunctionReturnSet
POST /me/drive/root/workbook/functions/acosFunctionReturnSet
POST /workbooks/<id>/workbook/functions/acosFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acosFunctionReturnSet
