...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/timevalueFunctionReturnSet
POST /me/drive/root/workbook/functions/timevalueFunctionReturnSet
POST /workbooks/<id>/workbook/functions/timevalueFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/timevalueFunctionReturnSet
