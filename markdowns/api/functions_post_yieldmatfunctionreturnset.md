...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/yieldMatFunctionReturnSet
POST /me/drive/root/workbook/functions/yieldMatFunctionReturnSet
POST /workbooks/<id>/workbook/functions/yieldMatFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yieldMatFunctionReturnSet
