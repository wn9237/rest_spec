...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/logFunctionReturnSet
POST /me/drive/root/workbook/functions/logFunctionReturnSet
POST /workbooks/<id>/workbook/functions/logFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/logFunctionReturnSet
