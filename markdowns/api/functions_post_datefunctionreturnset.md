...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dateFunctionReturnSet
POST /me/drive/root/workbook/functions/dateFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dateFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dateFunctionReturnSet
