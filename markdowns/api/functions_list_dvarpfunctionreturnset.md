...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dvarPFunctionReturnSet
GET /me/drive/root/workbook/functions/dvarPFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dvarPFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dvarpfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dvarPFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dvarPFunctionReturnSet",
  "keywords": "",
