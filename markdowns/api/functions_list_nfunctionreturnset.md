...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/nfunctionReturnSet
GET /me/drive/root/workbook/functions/nfunctionReturnSet
GET /workbooks/<id>/workbook/functions/nfunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_nfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nfunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List nfunctionReturnSet",
  "keywords": "",
