...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dminFunctionReturnSet
GET /me/drive/root/workbook/functions/dminFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dminFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dminfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dminFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dminFunctionReturnSet",
  "keywords": "",
