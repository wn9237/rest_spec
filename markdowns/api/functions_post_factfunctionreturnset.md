...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/factFunctionReturnSet
POST /me/drive/root/workbook/functions/factFunctionReturnSet
POST /workbooks/<id>/workbook/functions/factFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/factFunctionReturnSet
