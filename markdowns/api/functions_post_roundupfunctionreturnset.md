...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/roundUpFunctionReturnSet
POST /me/drive/root/workbook/functions/roundUpFunctionReturnSet
POST /workbooks/<id>/workbook/functions/roundUpFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/roundUpFunctionReturnSet
