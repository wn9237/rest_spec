...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/standardizeFunctionReturnSet
POST /me/drive/root/workbook/functions/standardizeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/standardizeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/standardizeFunctionReturnSet
