...
<!-- { "blockType": "ignored" } -->
```http
PATCH /drive/root/workbook/tables/<id>/rows/<id>
PATCH /me/drive/root/workbook/tables/<id>/rows/<id>
PATCH /workbooks/<id>/workbook/tables/<id>/rows/<id>
```
...
```http
PATCH https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/rows/<id>
