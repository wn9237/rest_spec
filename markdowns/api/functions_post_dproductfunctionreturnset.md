...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dproductFunctionReturnSet
POST /me/drive/root/workbook/functions/dproductFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dproductFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dproductFunctionReturnSet
