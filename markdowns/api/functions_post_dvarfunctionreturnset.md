...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dvarFunctionReturnSet
POST /me/drive/root/workbook/functions/dvarFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dvarFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dvarFunctionReturnSet
