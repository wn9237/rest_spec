...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/varPAFunctionReturnSet
GET /me/drive/root/workbook/functions/varPAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/varPAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_varpafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/varPAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List varPAFunctionReturnSet",
  "keywords": "",
