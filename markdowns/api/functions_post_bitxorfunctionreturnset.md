...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bitxorFunctionReturnSet
POST /me/drive/root/workbook/functions/bitxorFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bitxorFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitxorFunctionReturnSet
