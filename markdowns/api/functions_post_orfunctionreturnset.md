...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/orFunctionReturnSet
POST /me/drive/root/workbook/functions/orFunctionReturnSet
POST /workbooks/<id>/workbook/functions/orFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/orFunctionReturnSet
