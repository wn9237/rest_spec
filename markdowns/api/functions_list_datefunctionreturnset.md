...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dateFunctionReturnSet
GET /me/drive/root/workbook/functions/dateFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dateFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_datefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dateFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dateFunctionReturnSet",
  "keywords": "",
