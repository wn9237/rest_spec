...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/permutationaFunctionReturnSet
POST /me/drive/root/workbook/functions/permutationaFunctionReturnSet
POST /workbooks/<id>/workbook/functions/permutationaFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/permutationaFunctionReturnSet
