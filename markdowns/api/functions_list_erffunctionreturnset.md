...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/erfFunctionReturnSet
GET /me/drive/root/workbook/functions/erfFunctionReturnSet
GET /workbooks/<id>/workbook/functions/erfFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_erffunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/erfFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List erfFunctionReturnSet",
  "keywords": "",
