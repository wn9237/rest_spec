...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/findBFunctionReturnSet
GET /me/drive/root/workbook/functions/findBFunctionReturnSet
GET /workbooks/<id>/workbook/functions/findBFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_findbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/findBFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List findBFunctionReturnSet",
  "keywords": "",
