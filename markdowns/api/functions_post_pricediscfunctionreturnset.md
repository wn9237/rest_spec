...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/priceDiscFunctionReturnSet
POST /me/drive/root/workbook/functions/priceDiscFunctionReturnSet
POST /workbooks/<id>/workbook/functions/priceDiscFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/priceDiscFunctionReturnSet
