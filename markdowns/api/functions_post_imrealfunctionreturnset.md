...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imRealFunctionReturnSet
POST /me/drive/root/workbook/functions/imRealFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imRealFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imRealFunctionReturnSet
