...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/piFunctionReturnSet
GET /me/drive/root/workbook/functions/piFunctionReturnSet
GET /workbooks/<id>/workbook/functions/piFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_pifunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/piFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List piFunctionReturnSet",
  "keywords": "",
