...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/ascFunctionReturnSet
GET /me/drive/root/workbook/functions/ascFunctionReturnSet
GET /workbooks/<id>/workbook/functions/ascFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_ascfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ascFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List ascFunctionReturnSet",
  "keywords": "",
