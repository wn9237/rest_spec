...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/cosFunctionReturnSet
GET /me/drive/root/workbook/functions/cosFunctionReturnSet
GET /workbooks/<id>/workbook/functions/cosFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_cosfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cosFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List cosFunctionReturnSet",
  "keywords": "",
