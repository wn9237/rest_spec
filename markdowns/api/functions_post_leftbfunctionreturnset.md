...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/leftbFunctionReturnSet
POST /me/drive/root/workbook/functions/leftbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/leftbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/leftbFunctionReturnSet
