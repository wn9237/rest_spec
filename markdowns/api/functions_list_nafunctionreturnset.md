...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/naFunctionReturnSet
GET /me/drive/root/workbook/functions/naFunctionReturnSet
GET /workbooks/<id>/workbook/functions/naFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_nafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/naFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List naFunctionReturnSet",
  "keywords": "",
