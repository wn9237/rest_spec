...
Retrieve the properties and relationships of impossibletravelriskevent object.
### Prerequisites
...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [impossibleTravelRiskEvent](../resources/impossibletravelriskevent.md) object for supported names. |
...
```http
GET https://graph.microsoft.com/v1.0/impossibleTravelRiskEvents/<id>
```
##### Response
