...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/midbFunctionReturnSet
GET /me/drive/root/workbook/functions/midbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/midbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_midbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/midbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List midbFunctionReturnSet",
  "keywords": "",
