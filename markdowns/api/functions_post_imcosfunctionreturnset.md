...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imCosFunctionReturnSet
POST /me/drive/root/workbook/functions/imCosFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imCosFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCosFunctionReturnSet
