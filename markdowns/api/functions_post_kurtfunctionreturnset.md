...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/kurtFunctionReturnSet
POST /me/drive/root/workbook/functions/kurtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/kurtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/kurtFunctionReturnSet
