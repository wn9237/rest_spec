...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/permutFunctionReturnSet
GET /me/drive/root/workbook/functions/permutFunctionReturnSet
GET /workbooks/<id>/workbook/functions/permutFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_permutfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/permutFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List permutFunctionReturnSet",
  "keywords": "",
