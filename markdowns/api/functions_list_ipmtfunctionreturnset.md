...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/ipmtFunctionReturnSet
GET /me/drive/root/workbook/functions/ipmtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/ipmtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_ipmtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ipmtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List ipmtFunctionReturnSet",
  "keywords": "",
