...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>/rangeFunctionReturnSet
GET /me/drive/root/workbook/worksheets/<id>/rangeFunctionReturnSet
GET /workbooks/<id>/workbook/worksheets/<id>/rangeFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>/rangeFunctionReturnSet
```
##### Response
