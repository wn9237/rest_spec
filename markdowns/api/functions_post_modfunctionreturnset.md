...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/modFunctionReturnSet
POST /me/drive/root/workbook/functions/modFunctionReturnSet
POST /workbooks/<id>/workbook/functions/modFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/modFunctionReturnSet
