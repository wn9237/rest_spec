...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/expFunctionReturnSet
POST /me/drive/root/workbook/functions/expFunctionReturnSet
POST /workbooks/<id>/workbook/functions/expFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/expFunctionReturnSet
