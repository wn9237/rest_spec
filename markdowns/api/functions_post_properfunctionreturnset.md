...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/properFunctionReturnSet
POST /me/drive/root/workbook/functions/properFunctionReturnSet
POST /workbooks/<id>/workbook/functions/properFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/properFunctionReturnSet
