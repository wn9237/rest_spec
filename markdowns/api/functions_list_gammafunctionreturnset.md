...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/gammaFunctionReturnSet
GET /me/drive/root/workbook/functions/gammaFunctionReturnSet
GET /workbooks/<id>/workbook/functions/gammaFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_gammafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/gammaFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List gammaFunctionReturnSet",
  "keywords": "",
