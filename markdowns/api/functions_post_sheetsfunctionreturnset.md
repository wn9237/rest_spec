...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sheetsFunctionReturnSet
POST /me/drive/root/workbook/functions/sheetsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sheetsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sheetsFunctionReturnSet
