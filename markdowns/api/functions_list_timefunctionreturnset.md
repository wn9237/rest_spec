...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/timeFunctionReturnSet
GET /me/drive/root/workbook/functions/timeFunctionReturnSet
GET /workbooks/<id>/workbook/functions/timeFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_timefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/timeFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List timeFunctionReturnSet",
  "keywords": "",
