...
GET https://graph.microsoft.com/v1.0/users/<objectId>/JoinedGroups/<objectId>/CalendarView
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/JoinedGroups/<objectId>/CalendarView
```
