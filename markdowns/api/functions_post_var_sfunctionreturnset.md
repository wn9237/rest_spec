...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/var_SFunctionReturnSet
POST /me/drive/root/workbook/functions/var_SFunctionReturnSet
POST /workbooks/<id>/workbook/functions/var_SFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/var_SFunctionReturnSet
