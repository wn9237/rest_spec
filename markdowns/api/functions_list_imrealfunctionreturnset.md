...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imRealFunctionReturnSet
GET /me/drive/root/workbook/functions/imRealFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imRealFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imrealfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imRealFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imRealFunctionReturnSet",
  "keywords": "",
