...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dollarFunctionReturnSet
POST /me/drive/root/workbook/functions/dollarFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dollarFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dollarFunctionReturnSet
