...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dvarPFunctionReturnSet
POST /me/drive/root/workbook/functions/dvarPFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dvarPFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dvarPFunctionReturnSet
