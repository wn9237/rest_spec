...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dminFunctionReturnSet
POST /me/drive/root/workbook/functions/dminFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dminFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dminFunctionReturnSet
