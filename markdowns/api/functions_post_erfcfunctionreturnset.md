...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/erfCFunctionReturnSet
POST /me/drive/root/workbook/functions/erfCFunctionReturnSet
POST /workbooks/<id>/workbook/functions/erfCFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/erfCFunctionReturnSet
