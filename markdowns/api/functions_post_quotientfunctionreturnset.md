...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/quotientFunctionReturnSet
POST /me/drive/root/workbook/functions/quotientFunctionReturnSet
POST /workbooks/<id>/workbook/functions/quotientFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/quotientFunctionReturnSet
