...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dayFunctionReturnSet
GET /me/drive/root/workbook/functions/dayFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dayFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dayfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dayFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dayFunctionReturnSet",
  "keywords": "",
