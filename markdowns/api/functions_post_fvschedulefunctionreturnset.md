...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/fvscheduleFunctionReturnSet
POST /me/drive/root/workbook/functions/fvscheduleFunctionReturnSet
POST /workbooks/<id>/workbook/functions/fvscheduleFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fvscheduleFunctionReturnSet
