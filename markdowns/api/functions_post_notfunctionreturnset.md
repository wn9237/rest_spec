...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/notFunctionReturnSet
POST /me/drive/root/workbook/functions/notFunctionReturnSet
POST /workbooks/<id>/workbook/functions/notFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/notFunctionReturnSet
