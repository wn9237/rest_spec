...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/typeFunctionReturnSet
POST /me/drive/root/workbook/functions/typeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/typeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/typeFunctionReturnSet
