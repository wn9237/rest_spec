...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imCoshFunctionReturnSet
GET /me/drive/root/workbook/functions/imCoshFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imCoshFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imcoshfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCoshFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imCoshFunctionReturnSet",
  "keywords": "",
