...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/Messages/<Id>/Attachments
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/Messages/<Id>/Attachments
```
