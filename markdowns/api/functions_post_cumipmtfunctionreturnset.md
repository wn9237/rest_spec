...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cumIPmtFunctionReturnSet
POST /me/drive/root/workbook/functions/cumIPmtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cumIPmtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cumIPmtFunctionReturnSet
