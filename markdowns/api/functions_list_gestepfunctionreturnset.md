...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/geStepFunctionReturnSet
GET /me/drive/root/workbook/functions/geStepFunctionReturnSet
GET /workbooks/<id>/workbook/functions/geStepFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_gestepfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/geStepFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List geStepFunctionReturnSet",
  "keywords": "",
