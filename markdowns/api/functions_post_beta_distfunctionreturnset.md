...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/beta_DistFunctionReturnSet
POST /me/drive/root/workbook/functions/beta_DistFunctionReturnSet
POST /workbooks/<id>/workbook/functions/beta_DistFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/beta_DistFunctionReturnSet
