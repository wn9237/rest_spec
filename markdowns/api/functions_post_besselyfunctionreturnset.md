...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/besselYFunctionReturnSet
POST /me/drive/root/workbook/functions/besselYFunctionReturnSet
POST /workbooks/<id>/workbook/functions/besselYFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/besselYFunctionReturnSet
