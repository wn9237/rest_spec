...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/chooseFunctionReturnSet
GET /me/drive/root/workbook/functions/chooseFunctionReturnSet
GET /workbooks/<id>/workbook/functions/chooseFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_choosefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/chooseFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List chooseFunctionReturnSet",
  "keywords": "",
