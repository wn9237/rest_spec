...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/minAFunctionReturnSet
GET /me/drive/root/workbook/functions/minAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/minAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_minafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/minAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List minAFunctionReturnSet",
  "keywords": "",
