...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sumIfsFunctionReturnSet
GET /me/drive/root/workbook/functions/sumIfsFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sumIfsFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sumifsfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumIfsFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sumIfsFunctionReturnSet",
  "keywords": "",
