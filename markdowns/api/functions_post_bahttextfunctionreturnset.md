...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bahtTextFunctionReturnSet
POST /me/drive/root/workbook/functions/bahtTextFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bahtTextFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bahtTextFunctionReturnSet
