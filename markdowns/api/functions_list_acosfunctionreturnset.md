...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/acosFunctionReturnSet
GET /me/drive/root/workbook/functions/acosFunctionReturnSet
GET /workbooks/<id>/workbook/functions/acosFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_acosfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acosFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List acosFunctionReturnSet",
  "keywords": "",
