...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/days360FunctionReturnSet
POST /me/drive/root/workbook/functions/days360FunctionReturnSet
POST /workbooks/<id>/workbook/functions/days360FunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/days360FunctionReturnSet
