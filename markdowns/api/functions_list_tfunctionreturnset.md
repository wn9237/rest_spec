...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/tfunctionReturnSet
GET /me/drive/root/workbook/functions/tfunctionReturnSet
GET /workbooks/<id>/workbook/functions/tfunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_tfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tfunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List tfunctionReturnSet",
  "keywords": "",
