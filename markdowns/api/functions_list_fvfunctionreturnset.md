...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/fvFunctionReturnSet
GET /me/drive/root/workbook/functions/fvFunctionReturnSet
GET /workbooks/<id>/workbook/functions/fvFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_fvfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fvFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List fvFunctionReturnSet",
  "keywords": "",
