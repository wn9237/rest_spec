...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/cleanFunctionReturnSet
GET /me/drive/root/workbook/functions/cleanFunctionReturnSet
GET /workbooks/<id>/workbook/functions/cleanFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_cleanfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cleanFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List cleanFunctionReturnSet",
  "keywords": "",
