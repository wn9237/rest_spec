...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/ContactFolders
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/ContactFolders
```
