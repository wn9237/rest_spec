...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sheetsFunctionReturnSet
GET /me/drive/root/workbook/functions/sheetsFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sheetsFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sheetsfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sheetsFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sheetsFunctionReturnSet",
  "keywords": "",
