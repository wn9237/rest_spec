...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/lenbFunctionReturnSet
POST /me/drive/root/workbook/functions/lenbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/lenbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lenbFunctionReturnSet
