...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/t_Dist_2TFunctionReturnSet
POST /me/drive/root/workbook/functions/t_Dist_2TFunctionReturnSet
POST /workbooks/<id>/workbook/functions/t_Dist_2TFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/t_Dist_2TFunctionReturnSet
