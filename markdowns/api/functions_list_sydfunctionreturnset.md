...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sydFunctionReturnSet
GET /me/drive/root/workbook/functions/sydFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sydFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sydfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sydFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sydFunctionReturnSet",
  "keywords": "",
