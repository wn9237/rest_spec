...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ceiling_PreciseFunctionReturnSet
POST /me/drive/root/workbook/functions/ceiling_PreciseFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ceiling_PreciseFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ceiling_PreciseFunctionReturnSet
