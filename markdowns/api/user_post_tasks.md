...
<!-- { "blockType": "ignored" } -->
```http
POST https://graph.microsoft.com/v1.0/users/<objectId>/tasks
POST https://graph.microsoft.com/v1.0/drive/root/createdByUser/tasks
POST https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/tasks
