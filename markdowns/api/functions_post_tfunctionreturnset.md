...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/tfunctionReturnSet
POST /me/drive/root/workbook/functions/tfunctionReturnSet
POST /workbooks/<id>/workbook/functions/tfunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tfunctionReturnSet
