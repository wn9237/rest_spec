...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/devSqFunctionReturnSet
POST /me/drive/root/workbook/functions/devSqFunctionReturnSet
POST /workbooks/<id>/workbook/functions/devSqFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/devSqFunctionReturnSet
