...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/isNAFunctionReturnSet
GET /me/drive/root/workbook/functions/isNAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/isNAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_isnafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isNAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List isNAFunctionReturnSet",
  "keywords": "",
