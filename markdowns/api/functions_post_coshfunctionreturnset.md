...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/coshFunctionReturnSet
POST /me/drive/root/workbook/functions/coshFunctionReturnSet
POST /workbooks/<id>/workbook/functions/coshFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coshFunctionReturnSet
