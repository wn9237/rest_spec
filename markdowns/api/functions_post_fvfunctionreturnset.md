...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/fvFunctionReturnSet
POST /me/drive/root/workbook/functions/fvFunctionReturnSet
POST /workbooks/<id>/workbook/functions/fvFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fvFunctionReturnSet
