...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/naFunctionReturnSet
POST /me/drive/root/workbook/functions/naFunctionReturnSet
POST /workbooks/<id>/workbook/functions/naFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/naFunctionReturnSet
