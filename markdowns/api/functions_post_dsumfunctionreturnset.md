...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dsumFunctionReturnSet
POST /me/drive/root/workbook/functions/dsumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dsumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dsumFunctionReturnSet
