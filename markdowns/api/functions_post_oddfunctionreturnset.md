...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/oddFunctionReturnSet
POST /me/drive/root/workbook/functions/oddFunctionReturnSet
POST /workbooks/<id>/workbook/functions/oddFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oddFunctionReturnSet
