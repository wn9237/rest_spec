...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/pvFunctionReturnSet
POST /me/drive/root/workbook/functions/pvFunctionReturnSet
POST /workbooks/<id>/workbook/functions/pvFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/pvFunctionReturnSet
