...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/t_InvFunctionReturnSet
GET /me/drive/root/workbook/functions/t_InvFunctionReturnSet
GET /workbooks/<id>/workbook/functions/t_InvFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_t_invfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/t_InvFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List t_InvFunctionReturnSet",
  "keywords": "",
