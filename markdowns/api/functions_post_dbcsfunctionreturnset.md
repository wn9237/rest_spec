...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dbcsFunctionReturnSet
POST /me/drive/root/workbook/functions/dbcsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dbcsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dbcsFunctionReturnSet
