...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/maxFunctionReturnSet
POST /me/drive/root/workbook/functions/maxFunctionReturnSet
POST /workbooks/<id>/workbook/functions/maxFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/maxFunctionReturnSet
