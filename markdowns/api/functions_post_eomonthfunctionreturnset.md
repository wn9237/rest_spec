...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/eoMonthFunctionReturnSet
POST /me/drive/root/workbook/functions/eoMonthFunctionReturnSet
POST /workbooks/<id>/workbook/functions/eoMonthFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/eoMonthFunctionReturnSet
