...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ppmtFunctionReturnSet
POST /me/drive/root/workbook/functions/ppmtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ppmtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ppmtFunctionReturnSet
