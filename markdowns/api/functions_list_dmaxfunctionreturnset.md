...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dmaxFunctionReturnSet
GET /me/drive/root/workbook/functions/dmaxFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dmaxFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dmaxfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dmaxFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dmaxFunctionReturnSet",
  "keywords": "",
