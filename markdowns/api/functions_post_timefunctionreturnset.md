...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/timeFunctionReturnSet
POST /me/drive/root/workbook/functions/timeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/timeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/timeFunctionReturnSet
