...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/roundDownFunctionReturnSet
POST /me/drive/root/workbook/functions/roundDownFunctionReturnSet
POST /workbooks/<id>/workbook/functions/roundDownFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/roundDownFunctionReturnSet
