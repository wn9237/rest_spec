...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imExpFunctionReturnSet
GET /me/drive/root/workbook/functions/imExpFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imExpFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imexpfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imExpFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imExpFunctionReturnSet",
  "keywords": "",
