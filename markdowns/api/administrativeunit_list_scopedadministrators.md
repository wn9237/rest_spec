...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [scopedRoleMembership](../resources/scopedrolemembership.md) for supported names. |
...
```http
GET https://graph.microsoft.com/v1.0/administrativeUnits/<id>/scopedAdministrators
```
##### Response
