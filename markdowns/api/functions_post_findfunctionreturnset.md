...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/findFunctionReturnSet
POST /me/drive/root/workbook/functions/findFunctionReturnSet
POST /workbooks/<id>/workbook/functions/findFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/findFunctionReturnSet
