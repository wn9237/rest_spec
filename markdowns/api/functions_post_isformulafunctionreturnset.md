...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isFormulaFunctionReturnSet
POST /me/drive/root/workbook/functions/isFormulaFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isFormulaFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isFormulaFunctionReturnSet
