...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/hourFunctionReturnSet
GET /me/drive/root/workbook/functions/hourFunctionReturnSet
GET /workbooks/<id>/workbook/functions/hourFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_hourfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/hourFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List hourFunctionReturnSet",
  "keywords": "",
