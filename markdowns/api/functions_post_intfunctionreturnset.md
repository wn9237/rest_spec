...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/intFunctionReturnSet
POST /me/drive/root/workbook/functions/intFunctionReturnSet
POST /workbooks/<id>/workbook/functions/intFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/intFunctionReturnSet
