...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/unicodeFunctionReturnSet
POST /me/drive/root/workbook/functions/unicodeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/unicodeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/unicodeFunctionReturnSet
