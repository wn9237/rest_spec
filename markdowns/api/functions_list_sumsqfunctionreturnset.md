...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sumSqFunctionReturnSet
GET /me/drive/root/workbook/functions/sumSqFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sumSqFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sumsqfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumSqFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sumSqFunctionReturnSet",
  "keywords": "",
