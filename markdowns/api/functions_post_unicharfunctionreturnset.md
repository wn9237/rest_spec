...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/unicharFunctionReturnSet
POST /me/drive/root/workbook/functions/unicharFunctionReturnSet
POST /workbooks/<id>/workbook/functions/unicharFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/unicharFunctionReturnSet
