...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dcountFunctionReturnSet
GET /me/drive/root/workbook/functions/dcountFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dcountFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dcountfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dcountFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dcountFunctionReturnSet",
  "keywords": "",
