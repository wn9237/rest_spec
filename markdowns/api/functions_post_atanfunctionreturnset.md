...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/atanFunctionReturnSet
POST /me/drive/root/workbook/functions/atanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/atanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/atanFunctionReturnSet
