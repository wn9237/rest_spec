...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/chiSq_Inv_RTFunctionReturnSet
POST /me/drive/root/workbook/functions/chiSq_Inv_RTFunctionReturnSet
POST /workbooks/<id>/workbook/functions/chiSq_Inv_RTFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/chiSq_Inv_RTFunctionReturnSet
