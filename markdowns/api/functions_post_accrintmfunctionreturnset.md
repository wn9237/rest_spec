...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/accrIntMFunctionReturnSet
POST /me/drive/root/workbook/functions/accrIntMFunctionReturnSet
POST /workbooks/<id>/workbook/functions/accrIntMFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/accrIntMFunctionReturnSet
