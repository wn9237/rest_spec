...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/hex2BinFunctionReturnSet
POST /me/drive/root/workbook/functions/hex2BinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/hex2BinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/hex2BinFunctionReturnSet
