...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/rateFunctionReturnSet
GET /me/drive/root/workbook/functions/rateFunctionReturnSet
GET /workbooks/<id>/workbook/functions/rateFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_ratefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rateFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List rateFunctionReturnSet",
  "keywords": "",
