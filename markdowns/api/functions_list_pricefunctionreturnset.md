...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/priceFunctionReturnSet
GET /me/drive/root/workbook/functions/priceFunctionReturnSet
GET /workbooks/<id>/workbook/functions/priceFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_pricefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/priceFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List priceFunctionReturnSet",
  "keywords": "",
