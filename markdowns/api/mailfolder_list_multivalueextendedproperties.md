...
<!-- { "blockType": "ignored" } -->
```http
GET /me/mailFolders/<id>/multiValueExtendedProperties
GET /users/<id>/mailFolders/<id>/multiValueExtendedProperties
GET /drive/root/createdByUser/mailFolders/<id>/multiValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/mailFolders/<id>/multiValueExtendedProperties
```
##### Response
