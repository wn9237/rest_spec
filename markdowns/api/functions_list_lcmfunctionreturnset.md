...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/lcmFunctionReturnSet
GET /me/drive/root/workbook/functions/lcmFunctionReturnSet
GET /workbooks/<id>/workbook/functions/lcmFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_lcmfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lcmFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List lcmFunctionReturnSet",
  "keywords": "",
