...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/acotFunctionReturnSet
GET /me/drive/root/workbook/functions/acotFunctionReturnSet
GET /workbooks/<id>/workbook/functions/acotFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_acotfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acotFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List acotFunctionReturnSet",
  "keywords": "",
