...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ifFunctionReturnSet
POST /me/drive/root/workbook/functions/ifFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ifFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ifFunctionReturnSet
