...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/powerFunctionReturnSet
POST /me/drive/root/workbook/functions/powerFunctionReturnSet
POST /workbooks/<id>/workbook/functions/powerFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/powerFunctionReturnSet
