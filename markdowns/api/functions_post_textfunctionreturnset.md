...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/textFunctionReturnSet
POST /me/drive/root/workbook/functions/textFunctionReturnSet
POST /workbooks/<id>/workbook/functions/textFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/textFunctionReturnSet
