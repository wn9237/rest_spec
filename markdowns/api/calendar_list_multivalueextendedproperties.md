...
GET /users/<id>/calendar/multiValueExtendedProperties
GET /groups/<id>/calendar/multiValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/calendar/multiValueExtendedProperties
```
##### Response
