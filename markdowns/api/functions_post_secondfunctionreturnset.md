...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/secondFunctionReturnSet
POST /me/drive/root/workbook/functions/secondFunctionReturnSet
POST /workbooks/<id>/workbook/functions/secondFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/secondFunctionReturnSet
