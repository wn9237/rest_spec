...
PATCH https://graph.microsoft.com/v1.0/drive/root/createdByUser/notes/notebooks/<id>
PATCH https://graph.microsoft.com/v1.0/users/<objectId>/notes/pages/<id>/parentNotebook
```
