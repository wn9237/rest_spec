...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/xirrFunctionReturnSet
GET /me/drive/root/workbook/functions/xirrFunctionReturnSet
GET /workbooks/<id>/workbook/functions/xirrFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_xirrfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/xirrFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List xirrFunctionReturnSet",
  "keywords": "",
