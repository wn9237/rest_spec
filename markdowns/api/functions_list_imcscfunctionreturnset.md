...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imCscFunctionReturnSet
GET /me/drive/root/workbook/functions/imCscFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imCscFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imcscfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCscFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imCscFunctionReturnSet",
  "keywords": "",
