...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSubFunctionReturnSet
POST /me/drive/root/workbook/functions/imSubFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSubFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSubFunctionReturnSet
