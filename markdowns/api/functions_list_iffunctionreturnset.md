...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/ifFunctionReturnSet
GET /me/drive/root/workbook/functions/ifFunctionReturnSet
GET /workbooks/<id>/workbook/functions/ifFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_iffunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ifFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List ifFunctionReturnSet",
  "keywords": "",
