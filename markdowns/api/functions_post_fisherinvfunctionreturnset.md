...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/fisherInvFunctionReturnSet
POST /me/drive/root/workbook/functions/fisherInvFunctionReturnSet
POST /workbooks/<id>/workbook/functions/fisherInvFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fisherInvFunctionReturnSet
