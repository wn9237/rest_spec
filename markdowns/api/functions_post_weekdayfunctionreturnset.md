...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/weekdayFunctionReturnSet
POST /me/drive/root/workbook/functions/weekdayFunctionReturnSet
POST /workbooks/<id>/workbook/functions/weekdayFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/weekdayFunctionReturnSet
