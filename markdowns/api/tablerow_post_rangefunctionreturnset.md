...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/tables/<id>/rows/rangeFunctionReturnSet
POST /me/drive/root/workbook/tables/<id>/rows/rangeFunctionReturnSet
POST /workbooks/<id>/workbook/tables/<id>/rows/rangeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/rows/rangeFunctionReturnSet
