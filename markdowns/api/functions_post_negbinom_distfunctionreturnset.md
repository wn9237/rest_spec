...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/negBinom_DistFunctionReturnSet
POST /me/drive/root/workbook/functions/negBinom_DistFunctionReturnSet
POST /workbooks/<id>/workbook/functions/negBinom_DistFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/negBinom_DistFunctionReturnSet
