...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/codeFunctionReturnSet
GET /me/drive/root/workbook/functions/codeFunctionReturnSet
GET /workbooks/<id>/workbook/functions/codeFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_codefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/codeFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List codeFunctionReturnSet",
  "keywords": "",
