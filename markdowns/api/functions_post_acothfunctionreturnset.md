...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/acothFunctionReturnSet
POST /me/drive/root/workbook/functions/acothFunctionReturnSet
POST /workbooks/<id>/workbook/functions/acothFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acothFunctionReturnSet
