...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/expFunctionReturnSet
GET /me/drive/root/workbook/functions/expFunctionReturnSet
GET /workbooks/<id>/workbook/functions/expFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_expfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/expFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List expFunctionReturnSet",
  "keywords": "",
