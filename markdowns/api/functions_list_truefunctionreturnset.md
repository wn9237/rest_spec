...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/trueFunctionReturnSet
GET /me/drive/root/workbook/functions/trueFunctionReturnSet
GET /workbooks/<id>/workbook/functions/trueFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_truefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/trueFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List trueFunctionReturnSet",
  "keywords": "",
