...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/maxAFunctionReturnSet
POST /me/drive/root/workbook/functions/maxAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/maxAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/maxAFunctionReturnSet
