...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dbFunctionReturnSet
POST /me/drive/root/workbook/functions/dbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dbFunctionReturnSet
