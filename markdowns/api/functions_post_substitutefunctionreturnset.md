...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/substituteFunctionReturnSet
POST /me/drive/root/workbook/functions/substituteFunctionReturnSet
POST /workbooks/<id>/workbook/functions/substituteFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/substituteFunctionReturnSet
