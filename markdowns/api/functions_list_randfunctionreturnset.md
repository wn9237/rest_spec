...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/randFunctionReturnSet
GET /me/drive/root/workbook/functions/randFunctionReturnSet
GET /workbooks/<id>/workbook/functions/randFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_randfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/randFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List randFunctionReturnSet",
  "keywords": "",
