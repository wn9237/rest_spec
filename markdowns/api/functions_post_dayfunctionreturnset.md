...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dayFunctionReturnSet
POST /me/drive/root/workbook/functions/dayFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dayFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dayFunctionReturnSet
