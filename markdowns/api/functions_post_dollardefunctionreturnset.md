...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dollarDeFunctionReturnSet
POST /me/drive/root/workbook/functions/dollarDeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dollarDeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dollarDeFunctionReturnSet
