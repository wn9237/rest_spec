...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imCoshFunctionReturnSet
POST /me/drive/root/workbook/functions/imCoshFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imCoshFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCoshFunctionReturnSet
