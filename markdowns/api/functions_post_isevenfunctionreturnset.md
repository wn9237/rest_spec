...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isEvenFunctionReturnSet
POST /me/drive/root/workbook/functions/isEvenFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isEvenFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isEvenFunctionReturnSet
