...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dbFunctionReturnSet
GET /me/drive/root/workbook/functions/dbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dbFunctionReturnSet",
  "keywords": "",
