...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/radiansFunctionReturnSet
POST /me/drive/root/workbook/functions/radiansFunctionReturnSet
POST /workbooks/<id>/workbook/functions/radiansFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/radiansFunctionReturnSet
