...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/oddFunctionReturnSet
GET /me/drive/root/workbook/functions/oddFunctionReturnSet
GET /workbooks/<id>/workbook/functions/oddFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_oddfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oddFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List oddFunctionReturnSet",
  "keywords": "",
