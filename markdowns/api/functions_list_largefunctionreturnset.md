...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/largeFunctionReturnSet
GET /me/drive/root/workbook/functions/largeFunctionReturnSet
GET /workbooks/<id>/workbook/functions/largeFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_largefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/largeFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List largeFunctionReturnSet",
  "keywords": "",
