...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imTanFunctionReturnSet
POST /me/drive/root/workbook/functions/imTanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imTanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imTanFunctionReturnSet
