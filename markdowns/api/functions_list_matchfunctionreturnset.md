...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/matchFunctionReturnSet
GET /me/drive/root/workbook/functions/matchFunctionReturnSet
GET /workbooks/<id>/workbook/functions/matchFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_matchfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/matchFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List matchFunctionReturnSet",
  "keywords": "",
