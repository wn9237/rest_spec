...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imLog2FunctionReturnSet
GET /me/drive/root/workbook/functions/imLog2FunctionReturnSet
GET /workbooks/<id>/workbook/functions/imLog2FunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imlog2functionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imLog2FunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imLog2FunctionReturnSet",
  "keywords": "",
