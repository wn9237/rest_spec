...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/npvFunctionReturnSet
GET /me/drive/root/workbook/functions/npvFunctionReturnSet
GET /workbooks/<id>/workbook/functions/npvFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_npvfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/npvFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List npvFunctionReturnSet",
  "keywords": "",
