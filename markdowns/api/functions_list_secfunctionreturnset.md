...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/secFunctionReturnSet
GET /me/drive/root/workbook/functions/secFunctionReturnSet
GET /workbooks/<id>/workbook/functions/secFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_secfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/secFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List secFunctionReturnSet",
  "keywords": "",
