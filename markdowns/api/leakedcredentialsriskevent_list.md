...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [leakedCredentialsRiskEvent](../resources/leakedcredentialsriskevent.md) for supported names. |
