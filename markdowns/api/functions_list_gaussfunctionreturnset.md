...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/gaussFunctionReturnSet
GET /me/drive/root/workbook/functions/gaussFunctionReturnSet
GET /workbooks/<id>/workbook/functions/gaussFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_gaussfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/gaussFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List gaussFunctionReturnSet",
  "keywords": "",
