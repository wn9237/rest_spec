...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/monthFunctionReturnSet
GET /me/drive/root/workbook/functions/monthFunctionReturnSet
GET /workbooks/<id>/workbook/functions/monthFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_monthfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/monthFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List monthFunctionReturnSet",
  "keywords": "",
