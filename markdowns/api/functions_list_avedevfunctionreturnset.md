...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/aveDevFunctionReturnSet
GET /me/drive/root/workbook/functions/aveDevFunctionReturnSet
GET /workbooks/<id>/workbook/functions/aveDevFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_avedevfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/aveDevFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List aveDevFunctionReturnSet",
  "keywords": "",
