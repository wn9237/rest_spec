...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/tbillPriceFunctionReturnSet
POST /me/drive/root/workbook/functions/tbillPriceFunctionReturnSet
POST /workbooks/<id>/workbook/functions/tbillPriceFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tbillPriceFunctionReturnSet
