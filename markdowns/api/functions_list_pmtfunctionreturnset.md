...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/pmtFunctionReturnSet
GET /me/drive/root/workbook/functions/pmtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/pmtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_pmtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/pmtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List pmtFunctionReturnSet",
  "keywords": "",
