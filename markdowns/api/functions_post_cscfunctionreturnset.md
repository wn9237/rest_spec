...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cscFunctionReturnSet
POST /me/drive/root/workbook/functions/cscFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cscFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cscFunctionReturnSet
