...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imCotFunctionReturnSet
GET /me/drive/root/workbook/functions/imCotFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imCotFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imcotfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCotFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imCotFunctionReturnSet",
  "keywords": "",
