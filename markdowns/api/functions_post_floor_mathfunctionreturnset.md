...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/floor_MathFunctionReturnSet
POST /me/drive/root/workbook/functions/floor_MathFunctionReturnSet
POST /workbooks/<id>/workbook/functions/floor_MathFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/floor_MathFunctionReturnSet
