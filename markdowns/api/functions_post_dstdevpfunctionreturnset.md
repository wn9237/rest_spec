...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dstDevPFunctionReturnSet
POST /me/drive/root/workbook/functions/dstDevPFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dstDevPFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dstDevPFunctionReturnSet
