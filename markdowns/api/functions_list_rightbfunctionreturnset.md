...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/rightbFunctionReturnSet
GET /me/drive/root/workbook/functions/rightbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/rightbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_rightbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rightbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List rightbFunctionReturnSet",
  "keywords": "",
