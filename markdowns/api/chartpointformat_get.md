...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>/format
GET /me/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>/format
GET /workbooks/<id>/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>/format
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>/format
```
##### Response
