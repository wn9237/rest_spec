...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/irrFunctionReturnSet
GET /me/drive/root/workbook/functions/irrFunctionReturnSet
GET /workbooks/<id>/workbook/functions/irrFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_irrfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/irrFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List irrFunctionReturnSet",
  "keywords": "",
