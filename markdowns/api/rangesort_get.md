...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/sort
GET /drive/root/workbook/tables/<id>/rangeFunctionReturnSet/<id>/sort
GET /me/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/sort
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/sort
```
##### Response
