...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imExpFunctionReturnSet
POST /me/drive/root/workbook/functions/imExpFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imExpFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imExpFunctionReturnSet
