...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/nperFunctionReturnSet
POST /me/drive/root/workbook/functions/nperFunctionReturnSet
POST /workbooks/<id>/workbook/functions/nperFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nperFunctionReturnSet
