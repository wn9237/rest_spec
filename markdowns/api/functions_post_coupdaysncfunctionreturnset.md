...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/coupDaysNcFunctionReturnSet
POST /me/drive/root/workbook/functions/coupDaysNcFunctionReturnSet
POST /workbooks/<id>/workbook/functions/coupDaysNcFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coupDaysNcFunctionReturnSet
