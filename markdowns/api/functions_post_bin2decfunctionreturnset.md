...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bin2DecFunctionReturnSet
POST /me/drive/root/workbook/functions/bin2DecFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bin2DecFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bin2DecFunctionReturnSet
