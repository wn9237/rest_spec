...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [identityRiskEvent](../resources/identityriskevent.md) for supported names. |
