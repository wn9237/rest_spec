...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<id>
GET /me/drive/root/workbook/names/<id>
GET /workbooks/<id>/workbook/names/<id>
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<id>
```
##### Response
