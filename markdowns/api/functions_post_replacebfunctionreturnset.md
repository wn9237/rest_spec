...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/replaceBFunctionReturnSet
POST /me/drive/root/workbook/functions/replaceBFunctionReturnSet
POST /workbooks/<id>/workbook/functions/replaceBFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/replaceBFunctionReturnSet
