...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isErrorFunctionReturnSet
POST /me/drive/root/workbook/functions/isErrorFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isErrorFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isErrorFunctionReturnSet
