...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cothFunctionReturnSet
POST /me/drive/root/workbook/functions/cothFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cothFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cothFunctionReturnSet
