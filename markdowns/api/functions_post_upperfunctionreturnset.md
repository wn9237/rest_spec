...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/upperFunctionReturnSet
POST /me/drive/root/workbook/functions/upperFunctionReturnSet
POST /workbooks/<id>/workbook/functions/upperFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/upperFunctionReturnSet
