...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/datevalueFunctionReturnSet
POST /me/drive/root/workbook/functions/datevalueFunctionReturnSet
POST /workbooks/<id>/workbook/functions/datevalueFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/datevalueFunctionReturnSet
