...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/atan2FunctionReturnSet
GET /me/drive/root/workbook/functions/atan2FunctionReturnSet
GET /workbooks/<id>/workbook/functions/atan2FunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_atan2functionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/atan2FunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List atan2FunctionReturnSet",
  "keywords": "",
