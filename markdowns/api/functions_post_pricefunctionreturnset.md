...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/priceFunctionReturnSet
POST /me/drive/root/workbook/functions/priceFunctionReturnSet
POST /workbooks/<id>/workbook/functions/priceFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/priceFunctionReturnSet
