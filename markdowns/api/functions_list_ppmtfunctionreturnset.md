...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/ppmtFunctionReturnSet
GET /me/drive/root/workbook/functions/ppmtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/ppmtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_ppmtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ppmtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List ppmtFunctionReturnSet",
  "keywords": "",
