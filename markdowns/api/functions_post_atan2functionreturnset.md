...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/atan2FunctionReturnSet
POST /me/drive/root/workbook/functions/atan2FunctionReturnSet
POST /workbooks/<id>/workbook/functions/atan2FunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/atan2FunctionReturnSet
