...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/absFunctionReturnSet
GET /me/drive/root/workbook/functions/absFunctionReturnSet
GET /workbooks/<id>/workbook/functions/absFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_absfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/absFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List absFunctionReturnSet",
  "keywords": "",
