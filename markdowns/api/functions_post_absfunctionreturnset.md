...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/absFunctionReturnSet
POST /me/drive/root/workbook/functions/absFunctionReturnSet
POST /workbooks/<id>/workbook/functions/absFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/absFunctionReturnSet
