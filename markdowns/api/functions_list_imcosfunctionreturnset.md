...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imCosFunctionReturnSet
GET /me/drive/root/workbook/functions/imCosFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imCosFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imcosfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCosFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imCosFunctionReturnSet",
  "keywords": "",
