...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/vdbFunctionReturnSet
GET /me/drive/root/workbook/functions/vdbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/vdbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_vdbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/vdbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List vdbFunctionReturnSet",
  "keywords": "",
