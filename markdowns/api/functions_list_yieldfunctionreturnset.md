...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/yieldFunctionReturnSet
GET /me/drive/root/workbook/functions/yieldFunctionReturnSet
GET /workbooks/<id>/workbook/functions/yieldFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_yieldfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yieldFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List yieldFunctionReturnSet",
  "keywords": "",
