...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/findFunctionReturnSet
GET /me/drive/root/workbook/functions/findFunctionReturnSet
GET /workbooks/<id>/workbook/functions/findFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_findfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/findFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List findFunctionReturnSet",
  "keywords": "",
