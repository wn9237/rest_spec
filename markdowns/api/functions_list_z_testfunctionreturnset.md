...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/z_TestFunctionReturnSet
GET /me/drive/root/workbook/functions/z_TestFunctionReturnSet
GET /workbooks/<id>/workbook/functions/z_TestFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_z_testfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/z_TestFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List z_TestFunctionReturnSet",
  "keywords": "",
