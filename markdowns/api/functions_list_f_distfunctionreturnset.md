...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/f_DistFunctionReturnSet
GET /me/drive/root/workbook/functions/f_DistFunctionReturnSet
GET /workbooks/<id>/workbook/functions/f_DistFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_f_distfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/f_DistFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List f_DistFunctionReturnSet",
  "keywords": "",
