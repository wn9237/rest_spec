...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imDivFunctionReturnSet
GET /me/drive/root/workbook/functions/imDivFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imDivFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imdivfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imDivFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imDivFunctionReturnSet",
  "keywords": "",
