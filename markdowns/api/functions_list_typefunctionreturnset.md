...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/typeFunctionReturnSet
GET /me/drive/root/workbook/functions/typeFunctionReturnSet
GET /workbooks/<id>/workbook/functions/typeFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_typefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/typeFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List typeFunctionReturnSet",
  "keywords": "",
