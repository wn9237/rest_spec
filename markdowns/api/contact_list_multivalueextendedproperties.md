...
<!-- { "blockType": "ignored" } -->
```http
GET /me/contacts/<id>/multiValueExtendedProperties
GET /users/<id>/contacts/<id>/multiValueExtendedProperties
GET /me/contactFolders/<id>/contacts/<id>/multiValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/contacts/<id>/multiValueExtendedProperties
```
##### Response
