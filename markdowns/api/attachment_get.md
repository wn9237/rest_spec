...
GET https://graph.microsoft.com/v1.0/groups/<objectId>/Events/<Id>/Attachments/<Id>
GET https://graph.microsoft.com/v1.0/users/<objectId>/Messages/<Id>/Attachments/<Id>
```
