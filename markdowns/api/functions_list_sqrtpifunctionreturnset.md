...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sqrtPiFunctionReturnSet
GET /me/drive/root/workbook/functions/sqrtPiFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sqrtPiFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sqrtpifunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sqrtPiFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sqrtPiFunctionReturnSet",
  "keywords": "",
