...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isNumberFunctionReturnSet
POST /me/drive/root/workbook/functions/isNumberFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isNumberFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isNumberFunctionReturnSet
