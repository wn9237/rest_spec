...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rateFunctionReturnSet
POST /me/drive/root/workbook/functions/rateFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rateFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rateFunctionReturnSet
