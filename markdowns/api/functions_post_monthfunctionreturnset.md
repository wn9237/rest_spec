...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/monthFunctionReturnSet
POST /me/drive/root/workbook/functions/monthFunctionReturnSet
POST /workbooks/<id>/workbook/functions/monthFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/monthFunctionReturnSet
