...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/MailFolders/<Id>/ChildFolders
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/MailFolders/<Id>/ChildFolders
```
