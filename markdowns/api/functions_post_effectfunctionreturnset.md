...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/effectFunctionReturnSet
POST /me/drive/root/workbook/functions/effectFunctionReturnSet
POST /workbooks/<id>/workbook/functions/effectFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/effectFunctionReturnSet
