...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/romanFunctionReturnSet
POST /me/drive/root/workbook/functions/romanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/romanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/romanFunctionReturnSet
