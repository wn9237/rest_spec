...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/trueFunctionReturnSet
POST /me/drive/root/workbook/functions/trueFunctionReturnSet
POST /workbooks/<id>/workbook/functions/trueFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/trueFunctionReturnSet
