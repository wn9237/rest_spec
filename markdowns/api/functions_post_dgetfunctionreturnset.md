...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dgetFunctionReturnSet
POST /me/drive/root/workbook/functions/dgetFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dgetFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dgetFunctionReturnSet
