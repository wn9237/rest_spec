...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/minuteFunctionReturnSet
POST /me/drive/root/workbook/functions/minuteFunctionReturnSet
POST /workbooks/<id>/workbook/functions/minuteFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/minuteFunctionReturnSet
