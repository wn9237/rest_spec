...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/stDevAFunctionReturnSet
GET /me/drive/root/workbook/functions/stDevAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/stDevAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_stdevafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/stDevAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List stDevAFunctionReturnSet",
  "keywords": "",
