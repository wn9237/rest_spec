...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/rightFunctionReturnSet
GET /me/drive/root/workbook/functions/rightFunctionReturnSet
GET /workbooks/<id>/workbook/functions/rightFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_rightfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rightFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List rightFunctionReturnSet",
  "keywords": "",
