...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/coupDaysFunctionReturnSet
POST /me/drive/root/workbook/functions/coupDaysFunctionReturnSet
POST /workbooks/<id>/workbook/functions/coupDaysFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coupDaysFunctionReturnSet
