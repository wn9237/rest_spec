...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/skewFunctionReturnSet
GET /me/drive/root/workbook/functions/skewFunctionReturnSet
GET /workbooks/<id>/workbook/functions/skewFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_skewfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/skewFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List skewFunctionReturnSet",
  "keywords": "",
