...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/leftFunctionReturnSet
GET /me/drive/root/workbook/functions/leftFunctionReturnSet
GET /workbooks/<id>/workbook/functions/leftFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_leftfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/leftFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List leftFunctionReturnSet",
  "keywords": "",
