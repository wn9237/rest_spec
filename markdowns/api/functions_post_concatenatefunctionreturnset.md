...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/concatenateFunctionReturnSet
POST /me/drive/root/workbook/functions/concatenateFunctionReturnSet
POST /workbooks/<id>/workbook/functions/concatenateFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/concatenateFunctionReturnSet
