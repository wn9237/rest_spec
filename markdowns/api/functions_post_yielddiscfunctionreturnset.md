...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/yieldDiscFunctionReturnSet
POST /me/drive/root/workbook/functions/yieldDiscFunctionReturnSet
POST /workbooks/<id>/workbook/functions/yieldDiscFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yieldDiscFunctionReturnSet
