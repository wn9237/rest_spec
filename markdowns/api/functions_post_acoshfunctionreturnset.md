...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/acoshFunctionReturnSet
POST /me/drive/root/workbook/functions/acoshFunctionReturnSet
POST /workbooks/<id>/workbook/functions/acoshFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acoshFunctionReturnSet
