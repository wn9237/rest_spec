...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ispmtFunctionReturnSet
POST /me/drive/root/workbook/functions/ispmtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ispmtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ispmtFunctionReturnSet
