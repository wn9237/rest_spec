...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<_Id>/rangeFunctionReturnSet
GET /me/drive/root/workbook/names/<_Id>/rangeFunctionReturnSet
GET /workbooks/<id>/workbook/names/<_Id>/rangeFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<_Id>/rangeFunctionReturnSet
```
##### Response
