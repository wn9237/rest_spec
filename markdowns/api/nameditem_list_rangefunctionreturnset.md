...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<id>/rangeFunctionReturnSet
GET /me/drive/root/workbook/names/<id>/rangeFunctionReturnSet
GET /workbooks/<id>/workbook/names/<id>/rangeFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<id>/rangeFunctionReturnSet
```
##### Response
