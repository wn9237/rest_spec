...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/var_PFunctionReturnSet
POST /me/drive/root/workbook/functions/var_PFunctionReturnSet
POST /workbooks/<id>/workbook/functions/var_PFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/var_PFunctionReturnSet
