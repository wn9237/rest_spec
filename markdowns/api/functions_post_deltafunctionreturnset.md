...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/deltaFunctionReturnSet
POST /me/drive/root/workbook/functions/deltaFunctionReturnSet
POST /workbooks/<id>/workbook/functions/deltaFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/deltaFunctionReturnSet
