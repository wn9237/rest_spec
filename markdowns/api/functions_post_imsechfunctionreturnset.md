...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSechFunctionReturnSet
POST /me/drive/root/workbook/functions/imSechFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSechFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSechFunctionReturnSet
