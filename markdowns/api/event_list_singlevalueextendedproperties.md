...
<!-- { "blockType": "ignored" } -->
```http
GET /me/events/<id>/singleValueExtendedProperties
GET /me/calendarView/<id>/singleValueExtendedProperties
GET /users/<id>/events/<id>/singleValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/events/<id>/singleValueExtendedProperties
```
##### Response
