...
PATCH https://graph.microsoft.com/v1.0/drive/root/createdByUser/Messages/<Id>
PATCH https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/Messages/<Id>
```
