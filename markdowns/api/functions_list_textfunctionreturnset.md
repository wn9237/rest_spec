...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/textFunctionReturnSet
GET /me/drive/root/workbook/functions/textFunctionReturnSet
GET /workbooks/<id>/workbook/functions/textFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_textfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/textFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List textFunctionReturnSet",
  "keywords": "",
