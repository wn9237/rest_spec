...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/smallFunctionReturnSet
GET /me/drive/root/workbook/functions/smallFunctionReturnSet
GET /workbooks/<id>/workbook/functions/smallFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_smallfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/smallFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List smallFunctionReturnSet",
  "keywords": "",
