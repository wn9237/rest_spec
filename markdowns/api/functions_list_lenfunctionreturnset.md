...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/lenFunctionReturnSet
GET /me/drive/root/workbook/functions/lenFunctionReturnSet
GET /workbooks/<id>/workbook/functions/lenFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_lenfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lenFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List lenFunctionReturnSet",
  "keywords": "",
