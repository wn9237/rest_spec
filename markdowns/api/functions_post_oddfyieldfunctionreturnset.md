...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/oddFYieldFunctionReturnSet
POST /me/drive/root/workbook/functions/oddFYieldFunctionReturnSet
POST /workbooks/<id>/workbook/functions/oddFYieldFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oddFYieldFunctionReturnSet
