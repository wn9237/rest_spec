...
<!-- { "blockType": "ignored" } -->
```http
GET https://graph.microsoft.com/v1.0/users/<objectId>/tasks
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/tasks
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/tasks
```
