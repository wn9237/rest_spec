...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/midbFunctionReturnSet
POST /me/drive/root/workbook/functions/midbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/midbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/midbFunctionReturnSet
