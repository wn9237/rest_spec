...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/ddbFunctionReturnSet
GET /me/drive/root/workbook/functions/ddbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/ddbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_ddbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ddbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List ddbFunctionReturnSet",
  "keywords": "",
