...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rank_EqFunctionReturnSet
POST /me/drive/root/workbook/functions/rank_EqFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rank_EqFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rank_EqFunctionReturnSet
