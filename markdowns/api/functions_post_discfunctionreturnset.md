...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/discFunctionReturnSet
POST /me/drive/root/workbook/functions/discFunctionReturnSet
POST /workbooks/<id>/workbook/functions/discFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/discFunctionReturnSet
