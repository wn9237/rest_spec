...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/intRateFunctionReturnSet
POST /me/drive/root/workbook/functions/intRateFunctionReturnSet
POST /workbooks/<id>/workbook/functions/intRateFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/intRateFunctionReturnSet
