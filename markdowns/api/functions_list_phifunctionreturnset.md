...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/phiFunctionReturnSet
GET /me/drive/root/workbook/functions/phiFunctionReturnSet
GET /workbooks/<id>/workbook/functions/phiFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_phifunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/phiFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List phiFunctionReturnSet",
  "keywords": "",
