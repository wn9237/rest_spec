...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/lenFunctionReturnSet
POST /me/drive/root/workbook/functions/lenFunctionReturnSet
POST /workbooks/<id>/workbook/functions/lenFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lenFunctionReturnSet
