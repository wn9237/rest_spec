...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imCscFunctionReturnSet
POST /me/drive/root/workbook/functions/imCscFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imCscFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCscFunctionReturnSet
