...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/edateFunctionReturnSet
POST /me/drive/root/workbook/functions/edateFunctionReturnSet
POST /workbooks/<id>/workbook/functions/edateFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/edateFunctionReturnSet
