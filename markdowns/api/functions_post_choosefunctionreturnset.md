...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/chooseFunctionReturnSet
POST /me/drive/root/workbook/functions/chooseFunctionReturnSet
POST /workbooks/<id>/workbook/functions/chooseFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/chooseFunctionReturnSet
