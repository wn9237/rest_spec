...
<!-- { "blockType": "ignored" } -->
```http
GET /me/messages/<id>/singleValueExtendedProperties
GET /users/<id>/messages/<id>/singleValueExtendedProperties
GET /me/mailFolders/<id>/messages/<id>/singleValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/messages/<id>/singleValueExtendedProperties
```
##### Response
