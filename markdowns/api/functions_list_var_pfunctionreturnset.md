...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/var_PFunctionReturnSet
GET /me/drive/root/workbook/functions/var_PFunctionReturnSet
GET /workbooks/<id>/workbook/functions/var_PFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_var_pfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/var_PFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List var_PFunctionReturnSet",
  "keywords": "",
