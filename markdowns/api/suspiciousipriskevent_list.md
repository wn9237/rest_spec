...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) for supported names. |
