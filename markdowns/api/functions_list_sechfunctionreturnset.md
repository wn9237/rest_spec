...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sechFunctionReturnSet
GET /me/drive/root/workbook/functions/sechFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sechFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sechfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sechFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sechFunctionReturnSet",
  "keywords": "",
