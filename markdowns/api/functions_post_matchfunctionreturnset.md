...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/matchFunctionReturnSet
POST /me/drive/root/workbook/functions/matchFunctionReturnSet
POST /workbooks/<id>/workbook/functions/matchFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/matchFunctionReturnSet
