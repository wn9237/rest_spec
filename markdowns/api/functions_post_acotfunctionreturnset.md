...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/acotFunctionReturnSet
POST /me/drive/root/workbook/functions/acotFunctionReturnSet
POST /workbooks/<id>/workbook/functions/acotFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acotFunctionReturnSet
