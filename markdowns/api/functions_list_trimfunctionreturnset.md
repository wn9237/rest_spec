...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/trimFunctionReturnSet
GET /me/drive/root/workbook/functions/trimFunctionReturnSet
GET /workbooks/<id>/workbook/functions/trimFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_trimfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/trimFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List trimFunctionReturnSet",
  "keywords": "",
