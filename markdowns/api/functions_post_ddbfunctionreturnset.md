...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ddbFunctionReturnSet
POST /me/drive/root/workbook/functions/ddbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ddbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ddbFunctionReturnSet
