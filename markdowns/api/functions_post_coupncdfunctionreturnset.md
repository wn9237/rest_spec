...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/coupNcdFunctionReturnSet
POST /me/drive/root/workbook/functions/coupNcdFunctionReturnSet
POST /workbooks/<id>/workbook/functions/coupNcdFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coupNcdFunctionReturnSet
