...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sinhFunctionReturnSet
POST /me/drive/root/workbook/functions/sinhFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sinhFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sinhFunctionReturnSet
