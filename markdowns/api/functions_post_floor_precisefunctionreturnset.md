...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/floor_PreciseFunctionReturnSet
POST /me/drive/root/workbook/functions/floor_PreciseFunctionReturnSet
POST /workbooks/<id>/workbook/functions/floor_PreciseFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/floor_PreciseFunctionReturnSet
