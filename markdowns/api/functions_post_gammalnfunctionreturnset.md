...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/gammaLnFunctionReturnSet
POST /me/drive/root/workbook/functions/gammaLnFunctionReturnSet
POST /workbooks/<id>/workbook/functions/gammaLnFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/gammaLnFunctionReturnSet
