...
<!-- { "blockType": "ignored" } -->
```http
POST https://graph.microsoft.com/v1.0/users/<objectId>/notes/sectionGroups/<id>/sectionGroups
POST https://graph.microsoft.com/v1.0/drive/root/createdByUser/notes/sectionGroups/<id>/sectionGroups
POST https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/notes/sectionGroups/<id>/sectionGroups
