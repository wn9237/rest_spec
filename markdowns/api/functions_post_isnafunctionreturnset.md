...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isNAFunctionReturnSet
POST /me/drive/root/workbook/functions/isNAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isNAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isNAFunctionReturnSet
