...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/lnFunctionReturnSet
GET /me/drive/root/workbook/functions/lnFunctionReturnSet
GET /workbooks/<id>/workbook/functions/lnFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_lnfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lnFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List lnFunctionReturnSet",
  "keywords": "",
