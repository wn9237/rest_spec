...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/gcdFunctionReturnSet
POST /me/drive/root/workbook/functions/gcdFunctionReturnSet
POST /workbooks/<id>/workbook/functions/gcdFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/gcdFunctionReturnSet
