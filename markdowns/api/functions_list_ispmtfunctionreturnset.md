...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/ispmtFunctionReturnSet
GET /me/drive/root/workbook/functions/ispmtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/ispmtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_ispmtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ispmtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List ispmtFunctionReturnSet",
  "keywords": "",
