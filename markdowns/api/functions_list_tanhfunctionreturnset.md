...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/tanhFunctionReturnSet
GET /me/drive/root/workbook/functions/tanhFunctionReturnSet
GET /workbooks/<id>/workbook/functions/tanhFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_tanhfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tanhFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List tanhFunctionReturnSet",
  "keywords": "",
