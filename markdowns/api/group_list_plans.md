...
GET https://graph.microsoft.com/v1.0/users/<objectId>/JoinedGroups/<objectId>/plans
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/JoinedGroups/<objectId>/plans
```
