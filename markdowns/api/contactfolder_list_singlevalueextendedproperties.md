...
<!-- { "blockType": "ignored" } -->
```http
GET /me/contactFolders/<id>/singleValueExtendedProperties
GET /users/<id>/contactFolders/<id>/singleValueExtendedProperties
GET /drive/root/createdByUser/contactFolders/<id>/singleValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/contactFolders/<id>/singleValueExtendedProperties
```
##### Response
