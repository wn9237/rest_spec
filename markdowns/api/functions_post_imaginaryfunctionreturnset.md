...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imaginaryFunctionReturnSet
POST /me/drive/root/workbook/functions/imaginaryFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imaginaryFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imaginaryFunctionReturnSet
