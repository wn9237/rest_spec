...
GET /drive/root/createdByUser/mailFolders/<id>/singleValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/v1.0/me/mailFolders/<id>/singleValueExtendedProperties
```
##### Response
