...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sumFunctionReturnSet
POST /me/drive/root/workbook/functions/sumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumFunctionReturnSet
