...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dvarFunctionReturnSet
GET /me/drive/root/workbook/functions/dvarFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dvarFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dvarfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dvarFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dvarFunctionReturnSet",
  "keywords": "",
