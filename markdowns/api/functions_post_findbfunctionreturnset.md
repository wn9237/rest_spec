...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/findBFunctionReturnSet
POST /me/drive/root/workbook/functions/findBFunctionReturnSet
POST /workbooks/<id>/workbook/functions/findBFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/findBFunctionReturnSet
