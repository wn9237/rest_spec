...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/cothFunctionReturnSet
GET /me/drive/root/workbook/functions/cothFunctionReturnSet
GET /workbooks/<id>/workbook/functions/cothFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_cothfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cothFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List cothFunctionReturnSet",
  "keywords": "",
