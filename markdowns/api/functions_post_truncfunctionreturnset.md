...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/truncFunctionReturnSet
POST /me/drive/root/workbook/functions/truncFunctionReturnSet
POST /workbooks/<id>/workbook/functions/truncFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/truncFunctionReturnSet
