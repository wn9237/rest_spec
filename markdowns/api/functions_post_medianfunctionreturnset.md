...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/medianFunctionReturnSet
POST /me/drive/root/workbook/functions/medianFunctionReturnSet
POST /workbooks/<id>/workbook/functions/medianFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/medianFunctionReturnSet
