...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/countIfsFunctionReturnSet
POST /me/drive/root/workbook/functions/countIfsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/countIfsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countIfsFunctionReturnSet
