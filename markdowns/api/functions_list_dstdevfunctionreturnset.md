...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dstDevFunctionReturnSet
GET /me/drive/root/workbook/functions/dstDevFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dstDevFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dstdevfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dstDevFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dstDevFunctionReturnSet",
  "keywords": "",
