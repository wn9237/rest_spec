...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [driveItem](../resources/driveitem.md) for supported names. |
