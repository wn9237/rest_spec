...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/tables/<id>/rangeFunctionReturnSet/usedRangeFunctionReturnSet
GET /drive/root/workbook/names/<_Id>/rangeFunctionReturnSet/usedRangeFunctionReturnSet
GET /drive/root/workbook/worksheets/<id>/cellFunctionReturnSet/usedRangeFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/rangeFunctionReturnSet/usedRangeFunctionReturnSet
```
##### Response
