...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/f_InvFunctionReturnSet
GET /me/drive/root/workbook/functions/f_InvFunctionReturnSet
GET /workbooks/<id>/workbook/functions/f_InvFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_f_invfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/f_InvFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List f_InvFunctionReturnSet",
  "keywords": "",
