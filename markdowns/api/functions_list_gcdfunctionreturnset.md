...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/gcdFunctionReturnSet
GET /me/drive/root/workbook/functions/gcdFunctionReturnSet
GET /workbooks/<id>/workbook/functions/gcdFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_gcdfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/gcdFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List gcdFunctionReturnSet",
  "keywords": "",
