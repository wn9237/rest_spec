...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/replaceFunctionReturnSet
POST /me/drive/root/workbook/functions/replaceFunctionReturnSet
POST /workbooks/<id>/workbook/functions/replaceFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/replaceFunctionReturnSet
