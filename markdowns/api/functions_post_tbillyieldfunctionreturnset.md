...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/tbillYieldFunctionReturnSet
POST /me/drive/root/workbook/functions/tbillYieldFunctionReturnSet
POST /workbooks/<id>/workbook/functions/tbillYieldFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tbillYieldFunctionReturnSet
