...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/MailFolders/<Id>/Messages
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/MailFolders/<Id>/Messages
```
