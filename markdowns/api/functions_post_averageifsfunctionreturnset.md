...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/averageIfsFunctionReturnSet
POST /me/drive/root/workbook/functions/averageIfsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/averageIfsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/averageIfsFunctionReturnSet
