...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/networkDaysFunctionReturnSet
POST /me/drive/root/workbook/functions/networkDaysFunctionReturnSet
POST /workbooks/<id>/workbook/functions/networkDaysFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/networkDaysFunctionReturnSet
