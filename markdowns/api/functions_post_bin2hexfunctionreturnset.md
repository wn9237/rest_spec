...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bin2HexFunctionReturnSet
POST /me/drive/root/workbook/functions/bin2HexFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bin2HexFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bin2HexFunctionReturnSet
