...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSinFunctionReturnSet
GET /me/drive/root/workbook/functions/imSinFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSinFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsinfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSinFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSinFunctionReturnSet",
  "keywords": "",
