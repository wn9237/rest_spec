...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/xnpvFunctionReturnSet
GET /me/drive/root/workbook/functions/xnpvFunctionReturnSet
GET /workbooks/<id>/workbook/functions/xnpvFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_xnpvfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/xnpvFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List xnpvFunctionReturnSet",
  "keywords": "",
