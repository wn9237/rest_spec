...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/discFunctionReturnSet
GET /me/drive/root/workbook/functions/discFunctionReturnSet
GET /workbooks/<id>/workbook/functions/discFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_discfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/discFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List discFunctionReturnSet",
  "keywords": "",
