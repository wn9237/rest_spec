...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/smallFunctionReturnSet
POST /me/drive/root/workbook/functions/smallFunctionReturnSet
POST /workbooks/<id>/workbook/functions/smallFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/smallFunctionReturnSet
