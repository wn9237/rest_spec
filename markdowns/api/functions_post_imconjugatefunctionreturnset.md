...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imConjugateFunctionReturnSet
POST /me/drive/root/workbook/functions/imConjugateFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imConjugateFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imConjugateFunctionReturnSet
