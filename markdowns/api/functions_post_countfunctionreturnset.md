...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/countFunctionReturnSet
POST /me/drive/root/workbook/functions/countFunctionReturnSet
POST /workbooks/<id>/workbook/functions/countFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countFunctionReturnSet
