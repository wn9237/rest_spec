...
GET https://graph.microsoft.com/v1.0/servicePrincipals/<objectId>/appRoleAssignedTo
GET https://graph.microsoft.com/v1.0/groups/<objectId>/appRoleAssignments/<objectId>
```
