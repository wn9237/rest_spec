...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imDivFunctionReturnSet
POST /me/drive/root/workbook/functions/imDivFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imDivFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imDivFunctionReturnSet
