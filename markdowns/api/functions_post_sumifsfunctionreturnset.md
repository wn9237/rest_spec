...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sumIfsFunctionReturnSet
POST /me/drive/root/workbook/functions/sumIfsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sumIfsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumIfsFunctionReturnSet
