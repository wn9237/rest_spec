...
<!-- { "blockType": "ignored" } -->
```http
POST /me/messages/<id>/multiValueExtendedProperties
POST /users/<id>/messages/<id>/multiValueExtendedProperties
POST /me/mailFolders/<id>/messages/<id>/multiValueExtendedProperties
...
<!-- {
  "blockType": "request",
  "name": "create_multivaluelegacyextendedproperty_from_message"
}-->
```http
POST https://graph.microsoft.com/v1.0/me/messages/<id>/multiValueExtendedProperties
