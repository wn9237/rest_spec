...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/midFunctionReturnSet
POST /me/drive/root/workbook/functions/midFunctionReturnSet
POST /workbooks/<id>/workbook/functions/midFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/midFunctionReturnSet
