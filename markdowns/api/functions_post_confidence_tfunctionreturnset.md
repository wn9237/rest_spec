...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/confidence_TFunctionReturnSet
POST /me/drive/root/workbook/functions/confidence_TFunctionReturnSet
POST /workbooks/<id>/workbook/functions/confidence_TFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/confidence_TFunctionReturnSet
