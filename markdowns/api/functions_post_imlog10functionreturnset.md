...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imLog10FunctionReturnSet
POST /me/drive/root/workbook/functions/imLog10FunctionReturnSet
POST /workbooks/<id>/workbook/functions/imLog10FunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imLog10FunctionReturnSet
