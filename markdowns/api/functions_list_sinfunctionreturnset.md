...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sinFunctionReturnSet
GET /me/drive/root/workbook/functions/sinFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sinFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sinfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sinFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sinFunctionReturnSet",
  "keywords": "",
