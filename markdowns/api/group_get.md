...
GET https://graph.microsoft.com/v1.0/users/<objectId>/JoinedGroups/<objectId>
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/JoinedGroups/<objectId>
```
