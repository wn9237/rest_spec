...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sumIfFunctionReturnSet
POST /me/drive/root/workbook/functions/sumIfFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sumIfFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumIfFunctionReturnSet
