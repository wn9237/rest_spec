...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/notes/sectionGroups/<id>
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/notes/sectionGroups/<id>
```
