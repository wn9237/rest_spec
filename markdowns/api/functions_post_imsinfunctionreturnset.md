...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSinFunctionReturnSet
POST /me/drive/root/workbook/functions/imSinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSinFunctionReturnSet
