...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/notes/resources/<id>
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/notes/resources/<id>
```
