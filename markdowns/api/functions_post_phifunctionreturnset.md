...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/phiFunctionReturnSet
POST /me/drive/root/workbook/functions/phiFunctionReturnSet
POST /workbooks/<id>/workbook/functions/phiFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/phiFunctionReturnSet
