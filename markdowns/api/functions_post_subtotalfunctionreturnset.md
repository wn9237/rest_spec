...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/subtotalFunctionReturnSet
POST /me/drive/root/workbook/functions/subtotalFunctionReturnSet
POST /workbooks/<id>/workbook/functions/subtotalFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/subtotalFunctionReturnSet
