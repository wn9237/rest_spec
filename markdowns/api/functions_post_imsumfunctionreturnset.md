...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSumFunctionReturnSet
POST /me/drive/root/workbook/functions/imSumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSumFunctionReturnSet
