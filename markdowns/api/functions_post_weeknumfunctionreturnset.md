...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/weekNumFunctionReturnSet
POST /me/drive/root/workbook/functions/weekNumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/weekNumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/weekNumFunctionReturnSet
