...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imLnFunctionReturnSet
POST /me/drive/root/workbook/functions/imLnFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imLnFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imLnFunctionReturnSet
