...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/randFunctionReturnSet
POST /me/drive/root/workbook/functions/randFunctionReturnSet
POST /workbooks/<id>/workbook/functions/randFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/randFunctionReturnSet
