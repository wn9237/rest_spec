...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/cschFunctionReturnSet
GET /me/drive/root/workbook/functions/cschFunctionReturnSet
GET /workbooks/<id>/workbook/functions/cschFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_cschfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cschFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List cschFunctionReturnSet",
  "keywords": "",
