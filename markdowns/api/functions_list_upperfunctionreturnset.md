...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/upperFunctionReturnSet
GET /me/drive/root/workbook/functions/upperFunctionReturnSet
GET /workbooks/<id>/workbook/functions/upperFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_upperfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/upperFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List upperFunctionReturnSet",
  "keywords": "",
