...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/cscFunctionReturnSet
GET /me/drive/root/workbook/functions/cscFunctionReturnSet
GET /workbooks/<id>/workbook/functions/cscFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_cscfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cscFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List cscFunctionReturnSet",
  "keywords": "",
