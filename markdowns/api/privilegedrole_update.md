...
PATCH /privilegedApproval/<id>/roleInfo
PATCH /privilegedRoleAssignments/<id>/roleInfo
```
...
```http
PATCH https://graph.microsoft.com/beta/privilegedRoles/<id>
...
<!-- {
  ...
  "description": "Update privilegedrole",
  "keywords": "",
