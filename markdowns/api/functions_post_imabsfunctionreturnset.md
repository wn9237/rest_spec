...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imAbsFunctionReturnSet
POST /me/drive/root/workbook/functions/imAbsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imAbsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imAbsFunctionReturnSet
