...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/isTextFunctionReturnSet
GET /me/drive/root/workbook/functions/isTextFunctionReturnSet
GET /workbooks/<id>/workbook/functions/isTextFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_istextfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isTextFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List isTextFunctionReturnSet",
  "keywords": "",
