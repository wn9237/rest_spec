...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/kurtFunctionReturnSet
GET /me/drive/root/workbook/functions/kurtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/kurtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_kurtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/kurtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List kurtFunctionReturnSet",
  "keywords": "",
