...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/countBlankFunctionReturnSet
POST /me/drive/root/workbook/functions/countBlankFunctionReturnSet
POST /workbooks/<id>/workbook/functions/countBlankFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countBlankFunctionReturnSet
