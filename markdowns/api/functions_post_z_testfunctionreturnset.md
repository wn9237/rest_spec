...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/z_TestFunctionReturnSet
POST /me/drive/root/workbook/functions/z_TestFunctionReturnSet
POST /workbooks/<id>/workbook/functions/z_TestFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/z_TestFunctionReturnSet
