...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/falseFunctionReturnSet
POST /me/drive/root/workbook/functions/falseFunctionReturnSet
POST /workbooks/<id>/workbook/functions/falseFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/falseFunctionReturnSet
