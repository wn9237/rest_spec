...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/stDevPAFunctionReturnSet
POST /me/drive/root/workbook/functions/stDevPAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/stDevPAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/stDevPAFunctionReturnSet
