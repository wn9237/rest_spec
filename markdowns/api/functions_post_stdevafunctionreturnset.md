...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/stDevAFunctionReturnSet
POST /me/drive/root/workbook/functions/stDevAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/stDevAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/stDevAFunctionReturnSet
