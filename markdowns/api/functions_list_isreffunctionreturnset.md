...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/isrefFunctionReturnSet
GET /me/drive/root/workbook/functions/isrefFunctionReturnSet
GET /workbooks/<id>/workbook/functions/isrefFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_isreffunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isrefFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List isrefFunctionReturnSet",
  "keywords": "",
