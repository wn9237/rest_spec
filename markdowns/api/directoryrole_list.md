...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [directoryRole](../resources/directoryrole.md) for supported names. |
