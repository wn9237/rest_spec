...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sinhFunctionReturnSet
GET /me/drive/root/workbook/functions/sinhFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sinhFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sinhfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sinhFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sinhFunctionReturnSet",
  "keywords": "",
