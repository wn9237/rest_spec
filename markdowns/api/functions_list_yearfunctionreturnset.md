...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/yearFunctionReturnSet
GET /me/drive/root/workbook/functions/yearFunctionReturnSet
GET /workbooks/<id>/workbook/functions/yearFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_yearfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yearFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List yearFunctionReturnSet",
  "keywords": "",
