...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imPowerFunctionReturnSet
POST /me/drive/root/workbook/functions/imPowerFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imPowerFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imPowerFunctionReturnSet
