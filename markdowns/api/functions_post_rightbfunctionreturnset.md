...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rightbFunctionReturnSet
POST /me/drive/root/workbook/functions/rightbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rightbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rightbFunctionReturnSet
