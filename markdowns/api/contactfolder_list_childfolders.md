...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/ContactFolders/<Id>/ChildFolders
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/ContactFolders/<Id>/ChildFolders
```
