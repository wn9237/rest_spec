...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/todayFunctionReturnSet
GET /me/drive/root/workbook/functions/todayFunctionReturnSet
GET /workbooks/<id>/workbook/functions/todayFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_todayfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/todayFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List todayFunctionReturnSet",
  "keywords": "",
