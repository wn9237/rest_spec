...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/averageIfFunctionReturnSet
POST /me/drive/root/workbook/functions/averageIfFunctionReturnSet
POST /workbooks/<id>/workbook/functions/averageIfFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/averageIfFunctionReturnSet
