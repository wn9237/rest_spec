...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imCschFunctionReturnSet
POST /me/drive/root/workbook/functions/imCschFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imCschFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCschFunctionReturnSet
