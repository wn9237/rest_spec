...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dmaxFunctionReturnSet
POST /me/drive/root/workbook/functions/dmaxFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dmaxFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dmaxFunctionReturnSet
