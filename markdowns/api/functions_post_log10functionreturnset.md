...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/log10FunctionReturnSet
POST /me/drive/root/workbook/functions/log10FunctionReturnSet
POST /workbooks/<id>/workbook/functions/log10FunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/log10FunctionReturnSet
