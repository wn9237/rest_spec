...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/usdollarFunctionReturnSet
POST /me/drive/root/workbook/functions/usdollarFunctionReturnSet
POST /workbooks/<id>/workbook/functions/usdollarFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/usdollarFunctionReturnSet
