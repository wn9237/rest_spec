...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/npvFunctionReturnSet
POST /me/drive/root/workbook/functions/npvFunctionReturnSet
POST /workbooks/<id>/workbook/functions/npvFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/npvFunctionReturnSet
