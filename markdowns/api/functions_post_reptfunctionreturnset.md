...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/reptFunctionReturnSet
POST /me/drive/root/workbook/functions/reptFunctionReturnSet
POST /workbooks/<id>/workbook/functions/reptFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/reptFunctionReturnSet
