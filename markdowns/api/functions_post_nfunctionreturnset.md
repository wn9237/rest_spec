...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/nfunctionReturnSet
POST /me/drive/root/workbook/functions/nfunctionReturnSet
POST /workbooks/<id>/workbook/functions/nfunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nfunctionReturnSet
