...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/pdurationFunctionReturnSet
POST /me/drive/root/workbook/functions/pdurationFunctionReturnSet
POST /workbooks/<id>/workbook/functions/pdurationFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/pdurationFunctionReturnSet
