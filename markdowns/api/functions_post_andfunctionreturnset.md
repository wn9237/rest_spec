...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/andFunctionReturnSet
POST /me/drive/root/workbook/functions/andFunctionReturnSet
POST /workbooks/<id>/workbook/functions/andFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/andFunctionReturnSet
