...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/var_SFunctionReturnSet
GET /me/drive/root/workbook/functions/var_SFunctionReturnSet
GET /workbooks/<id>/workbook/functions/var_SFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_var_sfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/var_SFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List var_SFunctionReturnSet",
  "keywords": "",
