...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/notFunctionReturnSet
GET /me/drive/root/workbook/functions/notFunctionReturnSet
GET /workbooks/<id>/workbook/functions/notFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_notfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/notFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List notFunctionReturnSet",
  "keywords": "",
