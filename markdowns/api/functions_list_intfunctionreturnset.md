...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/intFunctionReturnSet
GET /me/drive/root/workbook/functions/intFunctionReturnSet
GET /workbooks/<id>/workbook/functions/intFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_intfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/intFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List intFunctionReturnSet",
  "keywords": "",
