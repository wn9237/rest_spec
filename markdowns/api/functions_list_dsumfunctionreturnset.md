...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dsumFunctionReturnSet
GET /me/drive/root/workbook/functions/dsumFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dsumFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dsumfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dsumFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dsumFunctionReturnSet",
  "keywords": "",
