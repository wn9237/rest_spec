...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [application](../resources/application.md) for supported names. |
