...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/xorFunctionReturnSet
GET /me/drive/root/workbook/functions/xorFunctionReturnSet
GET /workbooks/<id>/workbook/functions/xorFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_xorfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/xorFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List xorFunctionReturnSet",
  "keywords": "",
