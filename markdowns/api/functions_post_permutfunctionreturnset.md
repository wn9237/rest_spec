...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/permutFunctionReturnSet
POST /me/drive/root/workbook/functions/permutFunctionReturnSet
POST /workbooks/<id>/workbook/functions/permutFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/permutFunctionReturnSet
