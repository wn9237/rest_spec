...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/oddFPriceFunctionReturnSet
POST /me/drive/root/workbook/functions/oddFPriceFunctionReturnSet
POST /workbooks/<id>/workbook/functions/oddFPriceFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oddFPriceFunctionReturnSet
