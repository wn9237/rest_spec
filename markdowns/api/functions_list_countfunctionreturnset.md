...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/countFunctionReturnSet
GET /me/drive/root/workbook/functions/countFunctionReturnSet
GET /workbooks/<id>/workbook/functions/countFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_countfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List countFunctionReturnSet",
  "keywords": "",
