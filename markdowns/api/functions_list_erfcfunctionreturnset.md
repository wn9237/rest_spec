...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/erfCFunctionReturnSet
GET /me/drive/root/workbook/functions/erfCFunctionReturnSet
GET /workbooks/<id>/workbook/functions/erfCFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_erfcfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/erfCFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List erfCFunctionReturnSet",
  "keywords": "",
