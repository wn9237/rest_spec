...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/harMeanFunctionReturnSet
POST /me/drive/root/workbook/functions/harMeanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/harMeanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/harMeanFunctionReturnSet
