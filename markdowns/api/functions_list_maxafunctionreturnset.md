...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/maxAFunctionReturnSet
GET /me/drive/root/workbook/functions/maxAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/maxAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_maxafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/maxAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List maxAFunctionReturnSet",
  "keywords": "",
