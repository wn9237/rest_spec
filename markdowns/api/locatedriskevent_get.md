...
Retrieve the properties and relationships of locatedriskevent object.
### Prerequisites
...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [locatedRiskEvent](../resources/locatedriskevent.md) object for supported names. |
