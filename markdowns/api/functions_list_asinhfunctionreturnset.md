...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/asinhFunctionReturnSet
GET /me/drive/root/workbook/functions/asinhFunctionReturnSet
GET /workbooks/<id>/workbook/functions/asinhFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_asinhfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/asinhFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List asinhFunctionReturnSet",
  "keywords": "",
