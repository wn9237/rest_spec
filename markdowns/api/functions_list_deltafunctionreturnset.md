...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/deltaFunctionReturnSet
GET /me/drive/root/workbook/functions/deltaFunctionReturnSet
GET /workbooks/<id>/workbook/functions/deltaFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_deltafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/deltaFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List deltaFunctionReturnSet",
  "keywords": "",
