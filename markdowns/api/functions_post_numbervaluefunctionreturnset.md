...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/numberValueFunctionReturnSet
POST /me/drive/root/workbook/functions/numberValueFunctionReturnSet
POST /workbooks/<id>/workbook/functions/numberValueFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/numberValueFunctionReturnSet
