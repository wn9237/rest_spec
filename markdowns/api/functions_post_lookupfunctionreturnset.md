...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/lookupFunctionReturnSet
POST /me/drive/root/workbook/functions/lookupFunctionReturnSet
POST /workbooks/<id>/workbook/functions/lookupFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lookupFunctionReturnSet
