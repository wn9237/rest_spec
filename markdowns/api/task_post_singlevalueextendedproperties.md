...
<!-- { "blockType": "ignored" } -->
```http
POST /me/Tasks/<Id>/SingleValueExtendedProperties
POST /Users/<Id>/Tasks/<Id>/SingleValueExtendedProperties
POST /me/TaskFolders/<Id>/Tasks/<Id>/SingleValueExtendedProperties
...
<!-- {
  "blockType": "request",
  "name": "create_singlevaluelegacyextendedproperty_from_task"
}-->
```http
POST https://graph.microsoft.com/beta/me/Tasks/<Id>/SingleValueExtendedProperties
