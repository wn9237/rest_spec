...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/mirrFunctionReturnSet
POST /me/drive/root/workbook/functions/mirrFunctionReturnSet
POST /workbooks/<id>/workbook/functions/mirrFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/mirrFunctionReturnSet
