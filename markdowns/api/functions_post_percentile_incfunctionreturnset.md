...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/percentile_IncFunctionReturnSet
POST /me/drive/root/workbook/functions/percentile_IncFunctionReturnSet
POST /workbooks/<id>/workbook/functions/percentile_IncFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/percentile_IncFunctionReturnSet
