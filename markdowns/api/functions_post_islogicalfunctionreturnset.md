...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isLogicalFunctionReturnSet
POST /me/drive/root/workbook/functions/isLogicalFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isLogicalFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isLogicalFunctionReturnSet
