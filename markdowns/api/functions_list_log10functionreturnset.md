...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/log10FunctionReturnSet
GET /me/drive/root/workbook/functions/log10FunctionReturnSet
GET /workbooks/<id>/workbook/functions/log10FunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_log10functionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/log10FunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List log10FunctionReturnSet",
  "keywords": "",
