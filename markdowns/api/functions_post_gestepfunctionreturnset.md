...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/geStepFunctionReturnSet
POST /me/drive/root/workbook/functions/geStepFunctionReturnSet
POST /workbooks/<id>/workbook/functions/geStepFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/geStepFunctionReturnSet
