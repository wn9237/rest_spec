...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sumIfFunctionReturnSet
GET /me/drive/root/workbook/functions/sumIfFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sumIfFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sumiffunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumIfFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sumIfFunctionReturnSet",
  "keywords": "",
