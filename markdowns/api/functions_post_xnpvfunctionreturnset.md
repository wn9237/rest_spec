...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/xnpvFunctionReturnSet
POST /me/drive/root/workbook/functions/xnpvFunctionReturnSet
POST /workbooks/<id>/workbook/functions/xnpvFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/xnpvFunctionReturnSet
