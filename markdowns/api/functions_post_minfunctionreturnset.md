...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/minFunctionReturnSet
POST /me/drive/root/workbook/functions/minFunctionReturnSet
POST /workbooks/<id>/workbook/functions/minFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/minFunctionReturnSet
