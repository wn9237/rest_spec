...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/arabicFunctionReturnSet
POST /me/drive/root/workbook/functions/arabicFunctionReturnSet
POST /workbooks/<id>/workbook/functions/arabicFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/arabicFunctionReturnSet
