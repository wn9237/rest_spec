...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imProductFunctionReturnSet
POST /me/drive/root/workbook/functions/imProductFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imProductFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imProductFunctionReturnSet
