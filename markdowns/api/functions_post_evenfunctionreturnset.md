...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/evenFunctionReturnSet
POST /me/drive/root/workbook/functions/evenFunctionReturnSet
POST /workbooks/<id>/workbook/functions/evenFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/evenFunctionReturnSet
