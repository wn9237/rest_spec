...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/combinFunctionReturnSet
GET /me/drive/root/workbook/functions/combinFunctionReturnSet
GET /workbooks/<id>/workbook/functions/combinFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_combinfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/combinFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List combinFunctionReturnSet",
  "keywords": "",
