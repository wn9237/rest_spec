...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/networkDays_IntlFunctionReturnSet
POST /me/drive/root/workbook/functions/networkDays_IntlFunctionReturnSet
POST /workbooks/<id>/workbook/functions/networkDays_IntlFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/networkDays_IntlFunctionReturnSet
