...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/vlookupFunctionReturnSet
POST /me/drive/root/workbook/functions/vlookupFunctionReturnSet
POST /workbooks/<id>/workbook/functions/vlookupFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/vlookupFunctionReturnSet
