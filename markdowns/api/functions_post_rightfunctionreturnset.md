...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rightFunctionReturnSet
POST /me/drive/root/workbook/functions/rightFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rightFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rightFunctionReturnSet
