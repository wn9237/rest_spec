...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/atanFunctionReturnSet
GET /me/drive/root/workbook/functions/atanFunctionReturnSet
GET /workbooks/<id>/workbook/functions/atanFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_atanfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/atanFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List atanFunctionReturnSet",
  "keywords": "",
