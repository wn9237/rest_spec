...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/leftbFunctionReturnSet
GET /me/drive/root/workbook/functions/leftbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/leftbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_leftbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/leftbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List leftbFunctionReturnSet",
  "keywords": "",
