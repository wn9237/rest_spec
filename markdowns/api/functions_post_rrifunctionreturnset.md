...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rriFunctionReturnSet
POST /me/drive/root/workbook/functions/rriFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rriFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rriFunctionReturnSet
