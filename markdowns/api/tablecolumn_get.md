...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/tables/<id>/columns/<id>
GET /me/drive/root/workbook/tables/<id>/columns/<id>
GET /workbooks/<id>/workbook/tables/<id>/columns/<id>
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/columns/<id>
```
##### Response
