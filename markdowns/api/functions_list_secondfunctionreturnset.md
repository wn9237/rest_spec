...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/secondFunctionReturnSet
GET /me/drive/root/workbook/functions/secondFunctionReturnSet
GET /workbooks/<id>/workbook/functions/secondFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_secondfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/secondFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List secondFunctionReturnSet",
  "keywords": "",
