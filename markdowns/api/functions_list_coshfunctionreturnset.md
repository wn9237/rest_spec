...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/coshFunctionReturnSet
GET /me/drive/root/workbook/functions/coshFunctionReturnSet
GET /workbooks/<id>/workbook/functions/coshFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_coshfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/coshFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List coshFunctionReturnSet",
  "keywords": "",
