...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/reptFunctionReturnSet
GET /me/drive/root/workbook/functions/reptFunctionReturnSet
GET /workbooks/<id>/workbook/functions/reptFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_reptfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/reptFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List reptFunctionReturnSet",
  "keywords": "",
