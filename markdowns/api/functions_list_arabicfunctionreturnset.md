...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/arabicFunctionReturnSet
GET /me/drive/root/workbook/functions/arabicFunctionReturnSet
GET /workbooks/<id>/workbook/functions/arabicFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_arabicfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/arabicFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List arabicFunctionReturnSet",
  "keywords": "",
