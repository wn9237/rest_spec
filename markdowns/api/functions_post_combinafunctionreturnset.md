...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/combinaFunctionReturnSet
POST /me/drive/root/workbook/functions/combinaFunctionReturnSet
POST /workbooks/<id>/workbook/functions/combinaFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/combinaFunctionReturnSet
