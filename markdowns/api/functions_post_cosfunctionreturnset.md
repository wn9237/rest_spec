...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cosFunctionReturnSet
POST /me/drive/root/workbook/functions/cosFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cosFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cosFunctionReturnSet
