...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/t_DistFunctionReturnSet
GET /me/drive/root/workbook/functions/t_DistFunctionReturnSet
GET /workbooks/<id>/workbook/functions/t_DistFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_t_distfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/t_DistFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List t_DistFunctionReturnSet",
  "keywords": "",
