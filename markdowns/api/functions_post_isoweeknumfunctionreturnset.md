...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isoWeekNumFunctionReturnSet
POST /me/drive/root/workbook/functions/isoWeekNumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isoWeekNumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isoWeekNumFunctionReturnSet
