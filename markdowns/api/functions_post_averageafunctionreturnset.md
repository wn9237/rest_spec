...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/averageAFunctionReturnSet
POST /me/drive/root/workbook/functions/averageAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/averageAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/averageAFunctionReturnSet
