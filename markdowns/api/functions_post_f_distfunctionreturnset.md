...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/f_DistFunctionReturnSet
POST /me/drive/root/workbook/functions/f_DistFunctionReturnSet
POST /workbooks/<id>/workbook/functions/f_DistFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/f_DistFunctionReturnSet
