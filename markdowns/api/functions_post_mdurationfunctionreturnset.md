...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/mdurationFunctionReturnSet
POST /me/drive/root/workbook/functions/mdurationFunctionReturnSet
POST /workbooks/<id>/workbook/functions/mdurationFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/mdurationFunctionReturnSet
