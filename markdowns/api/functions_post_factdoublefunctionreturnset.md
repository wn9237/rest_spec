...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/factDoubleFunctionReturnSet
POST /me/drive/root/workbook/functions/factDoubleFunctionReturnSet
POST /workbooks/<id>/workbook/functions/factDoubleFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/factDoubleFunctionReturnSet
