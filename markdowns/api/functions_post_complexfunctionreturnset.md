...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/complexFunctionReturnSet
POST /me/drive/root/workbook/functions/complexFunctionReturnSet
POST /workbooks/<id>/workbook/functions/complexFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/complexFunctionReturnSet
