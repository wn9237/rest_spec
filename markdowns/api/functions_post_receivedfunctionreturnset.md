...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/receivedFunctionReturnSet
POST /me/drive/root/workbook/functions/receivedFunctionReturnSet
POST /workbooks/<id>/workbook/functions/receivedFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/receivedFunctionReturnSet
