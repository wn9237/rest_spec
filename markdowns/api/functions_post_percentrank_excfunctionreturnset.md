...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/percentRank_ExcFunctionReturnSet
POST /me/drive/root/workbook/functions/percentRank_ExcFunctionReturnSet
POST /workbooks/<id>/workbook/functions/percentRank_ExcFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/percentRank_ExcFunctionReturnSet
