...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/amorDegrcFunctionReturnSet
POST /me/drive/root/workbook/functions/amorDegrcFunctionReturnSet
POST /workbooks/<id>/workbook/functions/amorDegrcFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/amorDegrcFunctionReturnSet
