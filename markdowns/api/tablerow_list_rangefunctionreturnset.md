...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/tables/<id>/rows/<id>/rangeFunctionReturnSet
GET /me/drive/root/workbook/tables/<id>/rows/<id>/rangeFunctionReturnSet
GET /workbooks/<id>/workbook/tables/<id>/rows/<id>/rangeFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/rows/<id>/rangeFunctionReturnSet
```
##### Response
