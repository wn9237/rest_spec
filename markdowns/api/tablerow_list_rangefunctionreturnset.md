...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/tables/<id>/rows/rangeFunctionReturnSet
GET /me/drive/root/workbook/tables/<id>/rows/rangeFunctionReturnSet
GET /workbooks/<id>/workbook/tables/<id>/rows/rangeFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/rows/rangeFunctionReturnSet
```
##### Response
