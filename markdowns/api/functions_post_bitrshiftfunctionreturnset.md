...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bitrshiftFunctionReturnSet
POST /me/drive/root/workbook/functions/bitrshiftFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bitrshiftFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitrshiftFunctionReturnSet
