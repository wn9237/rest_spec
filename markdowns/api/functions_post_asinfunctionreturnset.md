...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/asinFunctionReturnSet
POST /me/drive/root/workbook/functions/asinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/asinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/asinFunctionReturnSet
