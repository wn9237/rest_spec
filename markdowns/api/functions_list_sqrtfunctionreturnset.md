...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sqrtFunctionReturnSet
GET /me/drive/root/workbook/functions/sqrtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sqrtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sqrtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sqrtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sqrtFunctionReturnSet",
  "keywords": "",
