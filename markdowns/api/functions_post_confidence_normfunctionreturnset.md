...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/confidence_NormFunctionReturnSet
POST /me/drive/root/workbook/functions/confidence_NormFunctionReturnSet
POST /workbooks/<id>/workbook/functions/confidence_NormFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/confidence_NormFunctionReturnSet
