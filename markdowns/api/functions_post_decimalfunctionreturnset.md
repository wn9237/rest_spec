...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/decimalFunctionReturnSet
POST /me/drive/root/workbook/functions/decimalFunctionReturnSet
POST /workbooks/<id>/workbook/functions/decimalFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/decimalFunctionReturnSet
