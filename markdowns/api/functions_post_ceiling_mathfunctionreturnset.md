...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ceiling_MathFunctionReturnSet
POST /me/drive/root/workbook/functions/ceiling_MathFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ceiling_MathFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ceiling_MathFunctionReturnSet
