...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/hyperlinkFunctionReturnSet
POST /me/drive/root/workbook/functions/hyperlinkFunctionReturnSet
POST /workbooks/<id>/workbook/functions/hyperlinkFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/hyperlinkFunctionReturnSet
