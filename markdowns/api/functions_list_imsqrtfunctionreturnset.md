...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSqrtFunctionReturnSet
GET /me/drive/root/workbook/functions/imSqrtFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSqrtFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsqrtfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSqrtFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSqrtFunctionReturnSet",
  "keywords": "",
