...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/fixedFunctionReturnSet
GET /me/drive/root/workbook/functions/fixedFunctionReturnSet
GET /workbooks/<id>/workbook/functions/fixedFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_fixedfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fixedFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List fixedFunctionReturnSet",
  "keywords": "",
