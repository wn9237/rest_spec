...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/signFunctionReturnSet
GET /me/drive/root/workbook/functions/signFunctionReturnSet
GET /workbooks/<id>/workbook/functions/signFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_signfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/signFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List signFunctionReturnSet",
  "keywords": "",
