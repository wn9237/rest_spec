...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/amorLincFunctionReturnSet
POST /me/drive/root/workbook/functions/amorLincFunctionReturnSet
POST /workbooks/<id>/workbook/functions/amorLincFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/amorLincFunctionReturnSet
