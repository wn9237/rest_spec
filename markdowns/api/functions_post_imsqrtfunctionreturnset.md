...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSqrtFunctionReturnSet
POST /me/drive/root/workbook/functions/imSqrtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSqrtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSqrtFunctionReturnSet
