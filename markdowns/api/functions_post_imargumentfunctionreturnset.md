...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imArgumentFunctionReturnSet
POST /me/drive/root/workbook/functions/imArgumentFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imArgumentFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imArgumentFunctionReturnSet
