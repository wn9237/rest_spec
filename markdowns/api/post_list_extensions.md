...
<!-- { "blockType": "ignored" } -->
```http
GET /groups/<id>/threads/<id>/posts/<id>/extensions
GET /me/joinedGroups/<id>/threads/<id>/posts/<id>/extensions
GET /users/<id>/joinedGroups/<id>/threads/<id>/posts/<id>/extensions
```
