...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/t_Dist_RTFunctionReturnSet
POST /me/drive/root/workbook/functions/t_Dist_RTFunctionReturnSet
POST /workbooks/<id>/workbook/functions/t_Dist_RTFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/t_Dist_RTFunctionReturnSet
