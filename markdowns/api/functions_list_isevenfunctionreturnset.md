...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/isEvenFunctionReturnSet
GET /me/drive/root/workbook/functions/isEvenFunctionReturnSet
GET /workbooks/<id>/workbook/functions/isEvenFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_isevenfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isEvenFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List isEvenFunctionReturnSet",
  "keywords": "",
