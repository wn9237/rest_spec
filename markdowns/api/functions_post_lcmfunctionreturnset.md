...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/lcmFunctionReturnSet
POST /me/drive/root/workbook/functions/lcmFunctionReturnSet
POST /workbooks/<id>/workbook/functions/lcmFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lcmFunctionReturnSet
