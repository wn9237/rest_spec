...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/areasFunctionReturnSet
GET /me/drive/root/workbook/functions/areasFunctionReturnSet
GET /workbooks/<id>/workbook/functions/areasFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_areasfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/areasFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List areasFunctionReturnSet",
  "keywords": "",
