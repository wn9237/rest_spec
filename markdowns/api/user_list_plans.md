...
<!-- { "blockType": "ignored" } -->
```http
GET https://graph.microsoft.com/v1.0/users/<objectId>/plans
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/plans
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/plans
```
