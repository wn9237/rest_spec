...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/xorFunctionReturnSet
POST /me/drive/root/workbook/functions/xorFunctionReturnSet
POST /workbooks/<id>/workbook/functions/xorFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/xorFunctionReturnSet
