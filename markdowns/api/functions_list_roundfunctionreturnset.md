...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/roundFunctionReturnSet
GET /me/drive/root/workbook/functions/roundFunctionReturnSet
GET /workbooks/<id>/workbook/functions/roundFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_roundfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/roundFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List roundFunctionReturnSet",
  "keywords": "",
