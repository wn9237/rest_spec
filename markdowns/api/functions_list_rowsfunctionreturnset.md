...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/rowsFunctionReturnSet
GET /me/drive/root/workbook/functions/rowsFunctionReturnSet
GET /workbooks/<id>/workbook/functions/rowsFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_rowsfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rowsFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List rowsFunctionReturnSet",
  "keywords": "",
