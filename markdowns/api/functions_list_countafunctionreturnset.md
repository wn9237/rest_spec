...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/countAFunctionReturnSet
GET /me/drive/root/workbook/functions/countAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/countAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_countafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List countAFunctionReturnSet",
  "keywords": "",
