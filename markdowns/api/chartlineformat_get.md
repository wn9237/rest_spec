...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>/charts/<id>/series/format/line
GET /me/drive/root/workbook/worksheets/<id>/charts/<id>/series/format/line
GET /workbooks/<id>/workbook/worksheets/<id>/charts/<id>/series/format/line
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>/charts/<id>/series/format/line
```
##### Response
