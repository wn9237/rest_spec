...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/format/line
GET /drive/root/workbook/worksheets/<id>/charts/<id>/axes/valueAxis/format/line
GET /me/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/format/line
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/format/line
```
##### Response
