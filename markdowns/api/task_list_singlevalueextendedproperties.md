...
<!-- { "blockType": "ignored" } -->
```http
GET /me/Tasks/<Id>/SingleValueExtendedProperties
GET /Users/<Id>/Tasks/<Id>/SingleValueExtendedProperties
GET /me/TaskFolders/<Id>/Tasks/<Id>/SingleValueExtendedProperties
```
...
```http
GET https://graph.microsoft.com/beta/me/Tasks/<Id>/SingleValueExtendedProperties
```
##### Response
