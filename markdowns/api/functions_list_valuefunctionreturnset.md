...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/valueFunctionReturnSet
GET /me/drive/root/workbook/functions/valueFunctionReturnSet
GET /workbooks/<id>/workbook/functions/valueFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_valuefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/valueFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List valueFunctionReturnSet",
  "keywords": "",
