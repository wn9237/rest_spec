...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imAbsFunctionReturnSet
GET /me/drive/root/workbook/functions/imAbsFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imAbsFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imabsfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imAbsFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imAbsFunctionReturnSet",
  "keywords": "",
