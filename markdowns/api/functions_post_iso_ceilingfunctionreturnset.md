...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/iso_CeilingFunctionReturnSet
POST /me/drive/root/workbook/functions/iso_CeilingFunctionReturnSet
POST /workbooks/<id>/workbook/functions/iso_CeilingFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/iso_CeilingFunctionReturnSet
