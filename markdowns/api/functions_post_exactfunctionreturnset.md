...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/exactFunctionReturnSet
POST /me/drive/root/workbook/functions/exactFunctionReturnSet
POST /workbooks/<id>/workbook/functions/exactFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/exactFunctionReturnSet
