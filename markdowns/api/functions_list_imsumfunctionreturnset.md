...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSumFunctionReturnSet
GET /me/drive/root/workbook/functions/imSumFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSumFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsumfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSumFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSumFunctionReturnSet",
  "keywords": "",
