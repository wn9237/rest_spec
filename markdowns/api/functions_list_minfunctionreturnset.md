...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/minFunctionReturnSet
GET /me/drive/root/workbook/functions/minFunctionReturnSet
GET /workbooks/<id>/workbook/functions/minFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_minfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/minFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List minFunctionReturnSet",
  "keywords": "",
