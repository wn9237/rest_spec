...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/factFunctionReturnSet
GET /me/drive/root/workbook/functions/factFunctionReturnSet
GET /workbooks/<id>/workbook/functions/factFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_factfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/factFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List factFunctionReturnSet",
  "keywords": "",
