...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/exactFunctionReturnSet
GET /me/drive/root/workbook/functions/exactFunctionReturnSet
GET /workbooks/<id>/workbook/functions/exactFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_exactfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/exactFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List exactFunctionReturnSet",
  "keywords": "",
