...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/asinhFunctionReturnSet
POST /me/drive/root/workbook/functions/asinhFunctionReturnSet
POST /workbooks/<id>/workbook/functions/asinhFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/asinhFunctionReturnSet
