...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dstDevFunctionReturnSet
POST /me/drive/root/workbook/functions/dstDevFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dstDevFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dstDevFunctionReturnSet
