...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/norm_S_InvFunctionReturnSet
POST /me/drive/root/workbook/functions/norm_S_InvFunctionReturnSet
POST /workbooks/<id>/workbook/functions/norm_S_InvFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/norm_S_InvFunctionReturnSet
