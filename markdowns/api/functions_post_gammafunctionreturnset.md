...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/gammaFunctionReturnSet
POST /me/drive/root/workbook/functions/gammaFunctionReturnSet
POST /workbooks/<id>/workbook/functions/gammaFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/gammaFunctionReturnSet
