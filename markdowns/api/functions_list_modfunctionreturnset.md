...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/modFunctionReturnSet
GET /me/drive/root/workbook/functions/modFunctionReturnSet
GET /workbooks/<id>/workbook/functions/modFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_modfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/modFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List modFunctionReturnSet",
  "keywords": "",
