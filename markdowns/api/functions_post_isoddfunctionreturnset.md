...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isOddFunctionReturnSet
POST /me/drive/root/workbook/functions/isOddFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isOddFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isOddFunctionReturnSet
