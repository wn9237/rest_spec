...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSecFunctionReturnSet
GET /me/drive/root/workbook/functions/imSecFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSecFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsecfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSecFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSecFunctionReturnSet",
  "keywords": "",
