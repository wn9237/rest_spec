...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/piFunctionReturnSet
POST /me/drive/root/workbook/functions/piFunctionReturnSet
POST /workbooks/<id>/workbook/functions/piFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/piFunctionReturnSet
