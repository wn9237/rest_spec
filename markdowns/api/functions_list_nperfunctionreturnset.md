...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/nperFunctionReturnSet
GET /me/drive/root/workbook/functions/nperFunctionReturnSet
GET /workbooks/<id>/workbook/functions/nperFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_nperfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nperFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List nperFunctionReturnSet",
  "keywords": "",
