...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/besselIFunctionReturnSet
POST /me/drive/root/workbook/functions/besselIFunctionReturnSet
POST /workbooks/<id>/workbook/functions/besselIFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/besselIFunctionReturnSet
