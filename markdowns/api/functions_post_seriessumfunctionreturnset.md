...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/seriesSumFunctionReturnSet
POST /me/drive/root/workbook/functions/seriesSumFunctionReturnSet
POST /workbooks/<id>/workbook/functions/seriesSumFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/seriesSumFunctionReturnSet
