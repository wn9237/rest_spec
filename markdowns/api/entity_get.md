...
GET /users/<id>/insights/trending/<id>/resource
GET /drive/root/createdByUser/insights/trending/<id>/resource
```
...
```http
GET https://graph.microsoft.com/v1.0/me/insights/trending/<id>/resource
```
##### Response
