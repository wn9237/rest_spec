...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [orgContact](../resources/orgcontact.md) for supported names. |
