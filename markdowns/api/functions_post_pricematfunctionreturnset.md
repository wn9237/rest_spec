...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/priceMatFunctionReturnSet
POST /me/drive/root/workbook/functions/priceMatFunctionReturnSet
POST /workbooks/<id>/workbook/functions/priceMatFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/priceMatFunctionReturnSet
