...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>
GET /me/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>
GET /workbooks/<id>/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points/<id>
```
##### Response
