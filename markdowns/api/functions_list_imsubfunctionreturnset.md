...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSubFunctionReturnSet
GET /me/drive/root/workbook/functions/imSubFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSubFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsubfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSubFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSubFunctionReturnSet",
  "keywords": "",
