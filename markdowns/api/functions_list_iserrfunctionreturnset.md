...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/isErrFunctionReturnSet
GET /me/drive/root/workbook/functions/isErrFunctionReturnSet
GET /workbooks/<id>/workbook/functions/isErrFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_iserrfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isErrFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List isErrFunctionReturnSet",
  "keywords": "",
