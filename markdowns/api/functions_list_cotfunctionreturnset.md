...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/cotFunctionReturnSet
GET /me/drive/root/workbook/functions/cotFunctionReturnSet
GET /workbooks/<id>/workbook/functions/cotFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_cotfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cotFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List cotFunctionReturnSet",
  "keywords": "",
