...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dgetFunctionReturnSet
GET /me/drive/root/workbook/functions/dgetFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dgetFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dgetfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dgetFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dgetFunctionReturnSet",
  "keywords": "",
