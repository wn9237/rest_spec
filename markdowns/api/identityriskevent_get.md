...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [identityRiskEvent](../resources/identityriskevent.md) object for supported names. |
...
```http
GET https://graph.microsoft.com/v1.0/identityRiskEvents/<id>
```
##### Response
