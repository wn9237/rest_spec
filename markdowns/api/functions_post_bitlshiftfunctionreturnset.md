...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bitlshiftFunctionReturnSet
POST /me/drive/root/workbook/functions/bitlshiftFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bitlshiftFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitlshiftFunctionReturnSet
