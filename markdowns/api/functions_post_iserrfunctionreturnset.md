...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isErrFunctionReturnSet
POST /me/drive/root/workbook/functions/isErrFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isErrFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isErrFunctionReturnSet
