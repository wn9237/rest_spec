...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/vdbFunctionReturnSet
POST /me/drive/root/workbook/functions/vdbFunctionReturnSet
POST /workbooks/<id>/workbook/functions/vdbFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/vdbFunctionReturnSet
