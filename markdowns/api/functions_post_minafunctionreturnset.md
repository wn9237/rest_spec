...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/minAFunctionReturnSet
POST /me/drive/root/workbook/functions/minAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/minAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/minAFunctionReturnSet
