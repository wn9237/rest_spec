...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sheetFunctionReturnSet
POST /me/drive/root/workbook/functions/sheetFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sheetFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sheetFunctionReturnSet
