...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/hlookupFunctionReturnSet
POST /me/drive/root/workbook/functions/hlookupFunctionReturnSet
POST /workbooks/<id>/workbook/functions/hlookupFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/hlookupFunctionReturnSet
