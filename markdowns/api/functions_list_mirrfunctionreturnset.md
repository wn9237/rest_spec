...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/mirrFunctionReturnSet
GET /me/drive/root/workbook/functions/mirrFunctionReturnSet
GET /workbooks/<id>/workbook/functions/mirrFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_mirrfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/mirrFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List mirrFunctionReturnSet",
  "keywords": "",
