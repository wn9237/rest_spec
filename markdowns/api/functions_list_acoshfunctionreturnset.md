...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/acoshFunctionReturnSet
GET /me/drive/root/workbook/functions/acoshFunctionReturnSet
GET /workbooks/<id>/workbook/functions/acoshFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_acoshfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/acoshFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List acoshFunctionReturnSet",
  "keywords": "",
