...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/baseFunctionReturnSet
POST /me/drive/root/workbook/functions/baseFunctionReturnSet
POST /workbooks/<id>/workbook/functions/baseFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/baseFunctionReturnSet
