...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bitandFunctionReturnSet
POST /me/drive/root/workbook/functions/bitandFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bitandFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitandFunctionReturnSet
