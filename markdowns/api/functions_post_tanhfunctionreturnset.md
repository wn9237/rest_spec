...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/tanhFunctionReturnSet
POST /me/drive/root/workbook/functions/tanhFunctionReturnSet
POST /workbooks/<id>/workbook/functions/tanhFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/tanhFunctionReturnSet
