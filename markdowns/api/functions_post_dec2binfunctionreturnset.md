...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dec2BinFunctionReturnSet
POST /me/drive/root/workbook/functions/dec2BinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dec2BinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dec2BinFunctionReturnSet
