...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/countIfFunctionReturnSet
POST /me/drive/root/workbook/functions/countIfFunctionReturnSet
POST /workbooks/<id>/workbook/functions/countIfFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countIfFunctionReturnSet
