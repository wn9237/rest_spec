...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/binom_Dist_RangeFunctionReturnSet
POST /me/drive/root/workbook/functions/binom_Dist_RangeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/binom_Dist_RangeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/binom_Dist_RangeFunctionReturnSet
