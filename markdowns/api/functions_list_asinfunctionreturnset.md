...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/asinFunctionReturnSet
GET /me/drive/root/workbook/functions/asinFunctionReturnSet
GET /workbooks/<id>/workbook/functions/asinFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_asinfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/asinFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List asinFunctionReturnSet",
  "keywords": "",
