...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/minuteFunctionReturnSet
GET /me/drive/root/workbook/functions/minuteFunctionReturnSet
GET /workbooks/<id>/workbook/functions/minuteFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_minutefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/minuteFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List minuteFunctionReturnSet",
  "keywords": "",
