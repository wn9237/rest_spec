...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cumPrincFunctionReturnSet
POST /me/drive/root/workbook/functions/cumPrincFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cumPrincFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cumPrincFunctionReturnSet
