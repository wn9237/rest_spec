...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>
GET /me/drive/root/workbook/worksheets/<id>
GET /workbooks/<id>/workbook/worksheets/<id>
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>
```
##### Response
