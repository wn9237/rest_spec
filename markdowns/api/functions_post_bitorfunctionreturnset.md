...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/bitorFunctionReturnSet
POST /me/drive/root/workbook/functions/bitorFunctionReturnSet
POST /workbooks/<id>/workbook/functions/bitorFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitorFunctionReturnSet
