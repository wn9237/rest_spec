...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/xirrFunctionReturnSet
POST /me/drive/root/workbook/functions/xirrFunctionReturnSet
POST /workbooks/<id>/workbook/functions/xirrFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/xirrFunctionReturnSet
