...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/durationFunctionReturnSet
POST /me/drive/root/workbook/functions/durationFunctionReturnSet
POST /workbooks/<id>/workbook/functions/durationFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/durationFunctionReturnSet
