...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/medianFunctionReturnSet
GET /me/drive/root/workbook/functions/medianFunctionReturnSet
GET /workbooks/<id>/workbook/functions/medianFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_medianfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/medianFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List medianFunctionReturnSet",
  "keywords": "",
