...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/logFunctionReturnSet
GET /me/drive/root/workbook/functions/logFunctionReturnSet
GET /workbooks/<id>/workbook/functions/logFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_logfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/logFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List logFunctionReturnSet",
  "keywords": "",
