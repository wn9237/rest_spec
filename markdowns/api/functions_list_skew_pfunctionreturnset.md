...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/skew_pFunctionReturnSet
GET /me/drive/root/workbook/functions/skew_pFunctionReturnSet
GET /workbooks/<id>/workbook/functions/skew_pFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_skew_pfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/skew_pFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List skew_pFunctionReturnSet",
  "keywords": "",
