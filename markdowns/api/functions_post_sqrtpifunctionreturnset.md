...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sqrtPiFunctionReturnSet
POST /me/drive/root/workbook/functions/sqrtPiFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sqrtPiFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sqrtPiFunctionReturnSet
