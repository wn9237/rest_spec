...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/edateFunctionReturnSet
GET /me/drive/root/workbook/functions/edateFunctionReturnSet
GET /workbooks/<id>/workbook/functions/edateFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_edatefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/edateFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List edateFunctionReturnSet",
  "keywords": "",
