...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ecma_CeilingFunctionReturnSet
POST /me/drive/root/workbook/functions/ecma_CeilingFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ecma_CeilingFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ecma_CeilingFunctionReturnSet
