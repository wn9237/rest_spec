...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/weibull_DistFunctionReturnSet
POST /me/drive/root/workbook/functions/weibull_DistFunctionReturnSet
POST /workbooks/<id>/workbook/functions/weibull_DistFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/weibull_DistFunctionReturnSet
