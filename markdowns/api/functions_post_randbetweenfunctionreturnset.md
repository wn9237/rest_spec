...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/randBetweenFunctionReturnSet
POST /me/drive/root/workbook/functions/randBetweenFunctionReturnSet
POST /workbooks/<id>/workbook/functions/randBetweenFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/randBetweenFunctionReturnSet
