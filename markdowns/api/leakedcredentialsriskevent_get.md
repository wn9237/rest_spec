...
Retrieve the properties and relationships of leakedcredentialsriskevent object.
### Prerequisites
...
|$expand|string|Comma-separated list of relationships to expand and include in the response. See relationships table of [leakedCredentialsRiskEvent](../resources/leakedcredentialsriskevent.md) object for supported names. |
...
```http
GET https://graph.microsoft.com/v1.0/leakedCredentialsRiskEvents/<id>
```
##### Response
