...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/rriFunctionReturnSet
GET /me/drive/root/workbook/functions/rriFunctionReturnSet
GET /workbooks/<id>/workbook/functions/rriFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_rrifunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rriFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List rriFunctionReturnSet",
  "keywords": "",
