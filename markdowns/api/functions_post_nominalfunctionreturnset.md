...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/nominalFunctionReturnSet
POST /me/drive/root/workbook/functions/nominalFunctionReturnSet
POST /workbooks/<id>/workbook/functions/nominalFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nominalFunctionReturnSet
