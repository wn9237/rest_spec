...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/mroundFunctionReturnSet
GET /me/drive/root/workbook/functions/mroundFunctionReturnSet
GET /workbooks/<id>/workbook/functions/mroundFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_mroundfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/mroundFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List mroundFunctionReturnSet",
  "keywords": "",
