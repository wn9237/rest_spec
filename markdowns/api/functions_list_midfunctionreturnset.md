...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/midFunctionReturnSet
GET /me/drive/root/workbook/functions/midFunctionReturnSet
GET /workbooks/<id>/workbook/functions/midFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_midfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/midFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List midFunctionReturnSet",
  "keywords": "",
