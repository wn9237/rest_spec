...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/falseFunctionReturnSet
GET /me/drive/root/workbook/functions/falseFunctionReturnSet
GET /workbooks/<id>/workbook/functions/falseFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_falsefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/falseFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List falseFunctionReturnSet",
  "keywords": "",
