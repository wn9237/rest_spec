...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/mroundFunctionReturnSet
POST /me/drive/root/workbook/functions/mroundFunctionReturnSet
POST /workbooks/<id>/workbook/functions/mroundFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/mroundFunctionReturnSet
