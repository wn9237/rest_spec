...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/dbcsFunctionReturnSet
GET /me/drive/root/workbook/functions/dbcsFunctionReturnSet
GET /workbooks/<id>/workbook/functions/dbcsFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_dbcsfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dbcsFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List dbcsFunctionReturnSet",
  "keywords": "",
