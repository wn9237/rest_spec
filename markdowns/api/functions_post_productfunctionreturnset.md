...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/productFunctionReturnSet
POST /me/drive/root/workbook/functions/productFunctionReturnSet
POST /workbooks/<id>/workbook/functions/productFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/productFunctionReturnSet
