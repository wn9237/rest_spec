...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sheetFunctionReturnSet
GET /me/drive/root/workbook/functions/sheetFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sheetFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sheetfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sheetFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sheetFunctionReturnSet",
  "keywords": "",
