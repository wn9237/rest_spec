...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/columnsFunctionReturnSet
POST /me/drive/root/workbook/functions/columnsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/columnsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/columnsFunctionReturnSet
