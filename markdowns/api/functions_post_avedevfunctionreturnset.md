...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/aveDevFunctionReturnSet
POST /me/drive/root/workbook/functions/aveDevFunctionReturnSet
POST /workbooks/<id>/workbook/functions/aveDevFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/aveDevFunctionReturnSet
