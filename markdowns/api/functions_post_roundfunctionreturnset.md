...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/roundFunctionReturnSet
POST /me/drive/root/workbook/functions/roundFunctionReturnSet
POST /workbooks/<id>/workbook/functions/roundFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/roundFunctionReturnSet
