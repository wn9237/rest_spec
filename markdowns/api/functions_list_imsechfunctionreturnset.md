...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/imSechFunctionReturnSet
GET /me/drive/root/workbook/functions/imSechFunctionReturnSet
GET /workbooks/<id>/workbook/functions/imSechFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_imsechfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSechFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List imSechFunctionReturnSet",
  "keywords": "",
