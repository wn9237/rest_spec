...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/sumFunctionReturnSet
GET /me/drive/root/workbook/functions/sumFunctionReturnSet
GET /workbooks/<id>/workbook/functions/sumFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_sumfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sumFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List sumFunctionReturnSet",
  "keywords": "",
