...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/besselJFunctionReturnSet
POST /me/drive/root/workbook/functions/besselJFunctionReturnSet
POST /workbooks/<id>/workbook/functions/besselJFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/besselJFunctionReturnSet
