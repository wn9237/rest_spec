...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/daverageFunctionReturnSet
POST /me/drive/root/workbook/functions/daverageFunctionReturnSet
POST /workbooks/<id>/workbook/functions/daverageFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/daverageFunctionReturnSet
