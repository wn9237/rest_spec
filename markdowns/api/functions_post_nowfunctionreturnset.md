...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/nowFunctionReturnSet
POST /me/drive/root/workbook/functions/nowFunctionReturnSet
POST /workbooks/<id>/workbook/functions/nowFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/nowFunctionReturnSet
