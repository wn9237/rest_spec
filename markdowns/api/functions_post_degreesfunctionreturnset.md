...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/degreesFunctionReturnSet
POST /me/drive/root/workbook/functions/degreesFunctionReturnSet
POST /workbooks/<id>/workbook/functions/degreesFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/degreesFunctionReturnSet
