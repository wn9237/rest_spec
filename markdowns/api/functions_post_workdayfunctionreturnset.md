...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/workDayFunctionReturnSet
POST /me/drive/root/workbook/functions/workDayFunctionReturnSet
POST /workbooks/<id>/workbook/functions/workDayFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/workDayFunctionReturnSet
