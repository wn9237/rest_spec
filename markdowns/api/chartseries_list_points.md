...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points
GET /me/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points
GET /workbooks/<id>/workbook/worksheets/<id>/charts/<id>/series/<id>/points
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/worksheets/<id>/charts/<id>/series/<id>/points
```
##### Response
