...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/multiNomialFunctionReturnSet
POST /me/drive/root/workbook/functions/multiNomialFunctionReturnSet
POST /workbooks/<id>/workbook/functions/multiNomialFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/multiNomialFunctionReturnSet
