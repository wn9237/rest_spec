...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imCotFunctionReturnSet
POST /me/drive/root/workbook/functions/imCotFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imCotFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imCotFunctionReturnSet
