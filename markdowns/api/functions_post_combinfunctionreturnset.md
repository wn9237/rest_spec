...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/combinFunctionReturnSet
POST /me/drive/root/workbook/functions/combinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/combinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/combinFunctionReturnSet
