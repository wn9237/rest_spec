...
<!-- { "blockType": "ignored" } -->
```http
POST /me/mailFolders/<id>/multiValueExtendedProperties
POST /users/<id>/mailFolders/<id>/multiValueExtendedProperties
POST /drive/root/createdByUser/mailFolders/<id>/multiValueExtendedProperties
...
<!-- {
  "blockType": "request",
  "name": "create_multivaluelegacyextendedproperty_from_mailfolder"
}-->
```http
POST https://graph.microsoft.com/v1.0/me/mailFolders/<id>/multiValueExtendedProperties
