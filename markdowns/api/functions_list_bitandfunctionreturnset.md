...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/bitandFunctionReturnSet
GET /me/drive/root/workbook/functions/bitandFunctionReturnSet
GET /workbooks/<id>/workbook/functions/bitandFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_bitandfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitandFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List bitandFunctionReturnSet",
  "keywords": "",
