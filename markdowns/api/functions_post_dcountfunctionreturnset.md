...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dcountFunctionReturnSet
POST /me/drive/root/workbook/functions/dcountFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dcountFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dcountFunctionReturnSet
