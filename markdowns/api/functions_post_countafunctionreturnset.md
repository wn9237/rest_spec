...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/countAFunctionReturnSet
POST /me/drive/root/workbook/functions/countAFunctionReturnSet
POST /workbooks/<id>/workbook/functions/countAFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/countAFunctionReturnSet
