...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/oddLPriceFunctionReturnSet
POST /me/drive/root/workbook/functions/oddLPriceFunctionReturnSet
POST /workbooks/<id>/workbook/functions/oddLPriceFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oddLPriceFunctionReturnSet
