...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/daysFunctionReturnSet
GET /me/drive/root/workbook/functions/daysFunctionReturnSet
GET /workbooks/<id>/workbook/functions/daysFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_daysfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/daysFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List daysFunctionReturnSet",
  "keywords": "",
