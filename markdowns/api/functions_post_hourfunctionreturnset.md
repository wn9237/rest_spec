...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/hourFunctionReturnSet
POST /me/drive/root/workbook/functions/hourFunctionReturnSet
POST /workbooks/<id>/workbook/functions/hourFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/hourFunctionReturnSet
