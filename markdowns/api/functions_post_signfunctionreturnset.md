...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/signFunctionReturnSet
POST /me/drive/root/workbook/functions/signFunctionReturnSet
POST /workbooks/<id>/workbook/functions/signFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/signFunctionReturnSet
