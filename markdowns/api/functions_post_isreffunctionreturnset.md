...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isrefFunctionReturnSet
POST /me/drive/root/workbook/functions/isrefFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isrefFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isrefFunctionReturnSet
