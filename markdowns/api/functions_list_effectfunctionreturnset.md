...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/effectFunctionReturnSet
GET /me/drive/root/workbook/functions/effectFunctionReturnSet
GET /workbooks/<id>/workbook/functions/effectFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_effectfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/effectFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List effectFunctionReturnSet",
  "keywords": "",
