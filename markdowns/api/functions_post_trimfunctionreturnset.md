...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/trimFunctionReturnSet
POST /me/drive/root/workbook/functions/trimFunctionReturnSet
POST /workbooks/<id>/workbook/functions/trimFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/trimFunctionReturnSet
