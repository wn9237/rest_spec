...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/skewFunctionReturnSet
POST /me/drive/root/workbook/functions/skewFunctionReturnSet
POST /workbooks/<id>/workbook/functions/skewFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/skewFunctionReturnSet
