...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/hex2DecFunctionReturnSet
POST /me/drive/root/workbook/functions/hex2DecFunctionReturnSet
POST /workbooks/<id>/workbook/functions/hex2DecFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/hex2DecFunctionReturnSet
