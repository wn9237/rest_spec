...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/trimMeanFunctionReturnSet
POST /me/drive/root/workbook/functions/trimMeanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/trimMeanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/trimMeanFunctionReturnSet
