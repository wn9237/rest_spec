...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/varAFunctionReturnSet
GET /me/drive/root/workbook/functions/varAFunctionReturnSet
GET /workbooks/<id>/workbook/functions/varAFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_varafunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/varAFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List varAFunctionReturnSet",
  "keywords": "",
