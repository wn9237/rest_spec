...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/cschFunctionReturnSet
POST /me/drive/root/workbook/functions/cschFunctionReturnSet
POST /workbooks/<id>/workbook/functions/cschFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/cschFunctionReturnSet
