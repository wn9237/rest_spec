...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/daysFunctionReturnSet
POST /me/drive/root/workbook/functions/daysFunctionReturnSet
POST /workbooks/<id>/workbook/functions/daysFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/daysFunctionReturnSet
