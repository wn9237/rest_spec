...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/percentile_ExcFunctionReturnSet
POST /me/drive/root/workbook/functions/percentile_ExcFunctionReturnSet
POST /workbooks/<id>/workbook/functions/percentile_ExcFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/percentile_ExcFunctionReturnSet
