...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/slnFunctionReturnSet
POST /me/drive/root/workbook/functions/slnFunctionReturnSet
POST /workbooks/<id>/workbook/functions/slnFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/slnFunctionReturnSet
