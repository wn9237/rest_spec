...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/format/protection
GET /drive/root/workbook/tables/<id>/rangeFunctionReturnSet/<id>/format/protection
GET /me/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/format/protection
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/format/protection
```
##### Response
