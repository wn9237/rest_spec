...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/lenbFunctionReturnSet
GET /me/drive/root/workbook/functions/lenbFunctionReturnSet
GET /workbooks/<id>/workbook/functions/lenbFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_lenbfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lenbFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List lenbFunctionReturnSet",
  "keywords": "",
