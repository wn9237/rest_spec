...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/fixedFunctionReturnSet
POST /me/drive/root/workbook/functions/fixedFunctionReturnSet
POST /workbooks/<id>/workbook/functions/fixedFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fixedFunctionReturnSet
