...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/oddLYieldFunctionReturnSet
POST /me/drive/root/workbook/functions/oddLYieldFunctionReturnSet
POST /workbooks/<id>/workbook/functions/oddLYieldFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/oddLYieldFunctionReturnSet
