...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/yearFunctionReturnSet
POST /me/drive/root/workbook/functions/yearFunctionReturnSet
POST /workbooks/<id>/workbook/functions/yearFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yearFunctionReturnSet
