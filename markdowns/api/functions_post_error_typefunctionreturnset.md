...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/error_TypeFunctionReturnSet
POST /me/drive/root/workbook/functions/error_TypeFunctionReturnSet
POST /workbooks/<id>/workbook/functions/error_TypeFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/error_TypeFunctionReturnSet
