...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/yieldFunctionReturnSet
POST /me/drive/root/workbook/functions/yieldFunctionReturnSet
POST /workbooks/<id>/workbook/functions/yieldFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/yieldFunctionReturnSet
