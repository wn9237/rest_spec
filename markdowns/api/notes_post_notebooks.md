...
<!-- { "blockType": "ignored" } -->
```http
POST https://graph.microsoft.com/v1.0/users/<objectId>/notes/notebooks
POST https://graph.microsoft.com/v1.0/drive/root/createdByUser/notes/notebooks
POST https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/notes/notebooks
