...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/bitorFunctionReturnSet
GET /me/drive/root/workbook/functions/bitorFunctionReturnSet
GET /workbooks/<id>/workbook/functions/bitorFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_bitorfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/bitorFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List bitorFunctionReturnSet",
  "keywords": "",
