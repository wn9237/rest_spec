...
<!-- { "blockType": "ignored" } -->
```http
GET /me/WorkingWithEntities/<Id>/Extensions
GET /Users/<Id>/WorkingWithEntities/<Id>/Extensions
```
...
```http
GET https://graph.microsoft.com/beta/me/WorkingWithEntities/<Id>/Extensions
```
##### Response
