...
<!-- { "blockType": "ignored" } -->
```http
GET /me/calendar/multiValueExtendedProperties/<id>
GET /me/events/<id>/multiValueExtendedProperties/<id>
GET /me/contacts/<id>/multiValueExtendedProperties/<id>
```
...
```http
GET https://graph.microsoft.com/v1.0/me/calendar/multiValueExtendedProperties/<id>
```
##### Response
