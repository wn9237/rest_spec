...
POST /privilegedApproval/<id>/roleInfo/assignments
POST /privilegedRoleAssignments/<id>/roleInfo/assignments
...
```http
POST https://graph.microsoft.com/beta/privilegedRoles/<id>/assignments
