...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/lnFunctionReturnSet
POST /me/drive/root/workbook/functions/lnFunctionReturnSet
POST /workbooks/<id>/workbook/functions/lnFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lnFunctionReturnSet
