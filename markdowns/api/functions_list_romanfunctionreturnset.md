...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/romanFunctionReturnSet
GET /me/drive/root/workbook/functions/romanFunctionReturnSet
GET /workbooks/<id>/workbook/functions/romanFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_romanfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/romanFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List romanFunctionReturnSet",
  "keywords": "",
