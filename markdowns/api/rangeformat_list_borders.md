...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/format/borders
GET /drive/root/workbook/tables/<id>/rangeFunctionReturnSet/<id>/format/borders
GET /me/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/format/borders
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/format/borders
```
##### Response
