...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/ipmtFunctionReturnSet
POST /me/drive/root/workbook/functions/ipmtFunctionReturnSet
POST /workbooks/<id>/workbook/functions/ipmtFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/ipmtFunctionReturnSet
