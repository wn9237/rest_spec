...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/fisherFunctionReturnSet
POST /me/drive/root/workbook/functions/fisherFunctionReturnSet
POST /workbooks/<id>/workbook/functions/fisherFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/fisherFunctionReturnSet
