...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/geoMeanFunctionReturnSet
POST /me/drive/root/workbook/functions/geoMeanFunctionReturnSet
POST /workbooks/<id>/workbook/functions/geoMeanFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/geoMeanFunctionReturnSet
