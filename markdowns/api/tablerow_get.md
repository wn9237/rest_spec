...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/tables/<id>/rows/<id>
GET /me/drive/root/workbook/tables/<id>/rows/<id>
GET /workbooks/<id>/workbook/tables/<id>/rows/<id>
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/tables/<id>/rows/<id>
```
##### Response
