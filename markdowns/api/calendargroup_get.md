...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/CalendarGroups/<Id>
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/CalendarGroups/<Id>
```
