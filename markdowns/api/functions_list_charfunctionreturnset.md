...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/charFunctionReturnSet
GET /me/drive/root/workbook/functions/charFunctionReturnSet
GET /workbooks/<id>/workbook/functions/charFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_charfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/charFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List charFunctionReturnSet",
  "keywords": "",
