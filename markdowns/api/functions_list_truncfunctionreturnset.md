...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/truncFunctionReturnSet
GET /me/drive/root/workbook/functions/truncFunctionReturnSet
GET /workbooks/<id>/workbook/functions/truncFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_truncfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/truncFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List truncFunctionReturnSet",
  "keywords": "",
