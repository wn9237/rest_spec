...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sechFunctionReturnSet
POST /me/drive/root/workbook/functions/sechFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sechFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sechFunctionReturnSet
