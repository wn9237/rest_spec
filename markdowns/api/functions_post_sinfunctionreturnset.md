...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/sinFunctionReturnSet
POST /me/drive/root/workbook/functions/sinFunctionReturnSet
POST /workbooks/<id>/workbook/functions/sinFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/sinFunctionReturnSet
