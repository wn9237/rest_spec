...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/andFunctionReturnSet
GET /me/drive/root/workbook/functions/andFunctionReturnSet
GET /workbooks/<id>/workbook/functions/andFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_andfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/andFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List andFunctionReturnSet",
  "keywords": "",
