...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/lowerFunctionReturnSet
POST /me/drive/root/workbook/functions/lowerFunctionReturnSet
POST /workbooks/<id>/workbook/functions/lowerFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lowerFunctionReturnSet
