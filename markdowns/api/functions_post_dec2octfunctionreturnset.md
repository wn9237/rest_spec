...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/dec2OctFunctionReturnSet
POST /me/drive/root/workbook/functions/dec2OctFunctionReturnSet
POST /workbooks/<id>/workbook/functions/dec2OctFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/dec2OctFunctionReturnSet
