...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/isOddFunctionReturnSet
GET /me/drive/root/workbook/functions/isOddFunctionReturnSet
GET /workbooks/<id>/workbook/functions/isOddFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_isoddfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isOddFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List isOddFunctionReturnSet",
  "keywords": "",
