...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/baseFunctionReturnSet
GET /me/drive/root/workbook/functions/baseFunctionReturnSet
GET /workbooks/<id>/workbook/functions/baseFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_basefunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/baseFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List baseFunctionReturnSet",
  "keywords": "",
