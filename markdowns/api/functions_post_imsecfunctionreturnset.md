...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/imSecFunctionReturnSet
POST /me/drive/root/workbook/functions/imSecFunctionReturnSet
POST /workbooks/<id>/workbook/functions/imSecFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/imSecFunctionReturnSet
