...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/irrFunctionReturnSet
POST /me/drive/root/workbook/functions/irrFunctionReturnSet
POST /workbooks/<id>/workbook/functions/irrFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/irrFunctionReturnSet
