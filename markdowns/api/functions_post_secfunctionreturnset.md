...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/secFunctionReturnSet
POST /me/drive/root/workbook/functions/secFunctionReturnSet
POST /workbooks/<id>/workbook/functions/secFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/secFunctionReturnSet
