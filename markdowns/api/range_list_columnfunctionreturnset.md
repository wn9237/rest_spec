...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/columnFunctionReturnSet
GET /drive/root/workbook/tables/<id>/rangeFunctionReturnSet/<id>/columnFunctionReturnSet
GET /me/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/columnFunctionReturnSet
```
...
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/names/<id>/rangeFunctionReturnSet/<id>/columnFunctionReturnSet
```
##### Response
