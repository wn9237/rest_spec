...
GET https://graph.microsoft.com/v1.0/drive/root/createdByUser/Messages/<Id>/Extensions
GET https://graph.microsoft.com/v1.0/drive/root/lastModifiedByUser/Messages/<Id>/Extensions
```
