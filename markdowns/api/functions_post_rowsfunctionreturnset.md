...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/rowsFunctionReturnSet
POST /me/drive/root/workbook/functions/rowsFunctionReturnSet
POST /workbooks/<id>/workbook/functions/rowsFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/rowsFunctionReturnSet
