...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/lookupFunctionReturnSet
GET /me/drive/root/workbook/functions/lookupFunctionReturnSet
GET /workbooks/<id>/workbook/functions/lookupFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_lookupfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/lookupFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List lookupFunctionReturnSet",
  "keywords": "",
