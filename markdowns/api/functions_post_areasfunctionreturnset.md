...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/areasFunctionReturnSet
POST /me/drive/root/workbook/functions/areasFunctionReturnSet
POST /workbooks/<id>/workbook/functions/areasFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/areasFunctionReturnSet
