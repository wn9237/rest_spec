...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/todayFunctionReturnSet
POST /me/drive/root/workbook/functions/todayFunctionReturnSet
POST /workbooks/<id>/workbook/functions/todayFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/todayFunctionReturnSet
