...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/charFunctionReturnSet
POST /me/drive/root/workbook/functions/charFunctionReturnSet
POST /workbooks/<id>/workbook/functions/charFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/charFunctionReturnSet
