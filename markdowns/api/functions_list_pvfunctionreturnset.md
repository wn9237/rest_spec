...
<!-- { "blockType": "ignored" } -->
```http
GET /drive/root/workbook/functions/pvFunctionReturnSet
GET /me/drive/root/workbook/functions/pvFunctionReturnSet
GET /workbooks/<id>/workbook/functions/pvFunctionReturnSet
```
...
<!-- {
  "blockType": "request",
  "name": "get_pvfunctionreturnset"
}-->
```http
GET https://graph.microsoft.com/v1.0/drive/root/workbook/functions/pvFunctionReturnSet
```
##### Response
...
<!-- {
  ...
  "description": "List pvFunctionReturnSet",
  "keywords": "",
