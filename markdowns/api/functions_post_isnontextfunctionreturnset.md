...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/isNonTextFunctionReturnSet
POST /me/drive/root/workbook/functions/isNonTextFunctionReturnSet
POST /workbooks/<id>/workbook/functions/isNonTextFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/isNonTextFunctionReturnSet
