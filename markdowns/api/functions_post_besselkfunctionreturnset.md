...
<!-- { "blockType": "ignored" } -->
```http
POST /drive/root/workbook/functions/besselKFunctionReturnSet
POST /me/drive/root/workbook/functions/besselKFunctionReturnSet
POST /workbooks/<id>/workbook/functions/besselKFunctionReturnSet
...
```http
POST https://graph.microsoft.com/v1.0/drive/root/workbook/functions/besselKFunctionReturnSet
